    ...
    <section className="flex min-h-[80vh] flex-col items-center justify-center px-5 py-16">
      ...
      <div className="mt-12 flex flex-wrap items-stretch justify-center gap-5 md:gap-7">
        ...
        {limitReached ? (
          <div
            aria-disabled
            className="flex w-36 md:w-44 flex-col items-center justify-center gap-3 rounded-3xl border-2 border-dashed border-[var(--color-ink-200)] p-6 text-center opacity-70"
          >
            <span className="rounded-full bg-[var(--color-cream-200)] p-4">
              <Lock className="h-6 w-6 text-[var(--color-ink-400)]" />
            </span>
            <span className="text-sm text-[var(--color-ink-500)]">{t("addChild")}</span>
