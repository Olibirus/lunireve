...
export default async function LibraryPage({
  ...
  for (const [k, v] of Object.entries(sp)) {
    if (
      typeof v === "string" &&
      ["character", "age", "theme", "interactive", "sort", "dir", "tag", "ccat", "tcat"].includes(k)
    ) {
      baseQuery[k] = v;
    }
  }
  ...
  const tCats = await getTranslations("filterCats");
 ...
 * value chips underneath. Server-rendered — open/close is a query param, so
 * every state stays a crawlable URL.
 */
