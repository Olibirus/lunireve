...
const STORY_CONTENT_EN: Record<string, StoryContent> = {
  ...
  "coucou-petit-chat": {
    body: [
      ...
      "Moustache tries under the table, between the chairs, right at the back. The tail sticks out anyway.",
      "He tries behind the big green plant, holding very still and not breathing at all. The tail sticks out anyway.",
  ...
  "le-premier-flocon-du-renardeau": {
    body: [
      ...
      "“Every winter? And I have never seen it before?” “This is your very first one,” says Mummy Fox, nudging him gently.",
      ...
      "He waits, nose in the air, mouth open, but nothing comes back at all. His tail droops a little in the snow.",
