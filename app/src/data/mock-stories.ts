...
export const mockStories: MockStory[] = [
  ...
  {
    slug: "la-licorne-qui-avait-perdu-ses-couleurs",
    publishedAt: "2026-06-27",
    title: "La licorne qui avait perdu ses couleurs",
    titleEn: "The unicorn who lost her colours",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "fantastique",
    theme: "amitie",
    subTheme: "se-sentir-tout-gris",
    character: "licorne",
    tags: ["licorne", "amitié", "couleurs", "prairie"],
    excerpt: "Un matin, Iris la licorne se réveille toute blanche. Ses amis, eux, ne remarquent rien du tout.",
    excerptEn: "One morning Iris the unicorn wakes up completely white. Her friends do not notice a thing.",
    cover: "cover-mint",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-loup-qui-voulait-juste-un-ami",
    publishedAt: "2026-07-04",
    title: "Le loup qui voulait juste un ami",
    titleEn: "The wolf who only wanted a friend",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "conte",
    theme: "amitie",
    subTheme: "oser-dire-bonjour",
    character: "loup",
    tags: ["loup", "amitié", "forêt", "timidité"],
    excerpt: "Gris le loup s'entraîne tous les soirs à dire bonjour. Le problème, c'est que tout le monde se sauve avant la fin du mot.",
    excerptEn: "Gris the wolf practises saying hello every evening. The trouble is that everyone runs away before he finishes the word.",
    cover: "cover-dusk",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "nino-part-a-l-ecole-des-petits",
    publishedAt: "2026-07-11",
    title: "Nino part à l'école des petits",
    titleEn: "Nino starts at the little school",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "educative",
    theme: "ecole",
    subTheme: "premier-jour-decole",
    character: "enfant-garcon",
    tags: ["école", "rentrée", "première fois", "doudou"],
    excerpt: "Premier jour d'école pour Nino. Son doudou vient aussi, bien caché au fond du cartable.",
    excerptEn: "It is Nino's first day of school. His cuddly toy comes too, hidden at the bottom of the satchel.",
    cover: "cover-peach",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-gouter-surprise-de-pilou",
    publishedAt: "2026-07-18",
    title: "Le goûter surprise de Pilou",
    titleEn: "Pilou's surprise party",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "fete",
    theme: "anniversaire",
    subTheme: "croire-quon-a-ete-oublie",
    character: "lapin",
    tags: ["lapin", "anniversaire", "surprise", "terrier"],
    excerpt: "C'est l'anniversaire de Pilou et personne ne lui a rien dit. Personne. Toute la journée.",
    excerptEn: "It is Pilou's birthday and nobody has said a word. Nobody. All day long.",
    cover: "cover-meadow",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-sapin-qui-n-aimait-pas-les-boules",
    publishedAt: "2026-07-25",
    title: "Le sapin qui n'aimait pas les boules",
    titleEn: "The fir tree who disliked baubles",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "fete",
    theme: "noel",
    subTheme: "etre-decore-autrement",
    character: "fee",
    tags: ["noël", "sapin", "fée", "hiver"],
    excerpt: "Toutes les boules glissent de ses branches. Ce sapin ne veut pas être décoré comme les autres.",
    excerptEn: "Every bauble slides off his branches. This fir tree does not want to be decorated like the others.",
    cover: "cover-night",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-dinosaure-qui-avait-peur-du-tonnerre",
    publishedAt: "2026-08-01",
    title: "Le dinosaure qui avait peur du tonnerre",
    titleEn: "The dinosaur who was scared of thunder",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 3,
    genre: "educative",
    theme: "emotions",
    subTheme: "peur-de-lorage",
    character: "dinosaure",
    tags: ["dinosaure", "orage", "peur", "réconfort"],
    excerpt: "Barnabé fait trembler la terre quand il marche. Mais quand le ciel gronde, c'est lui qui tremble.",
    excerptEn: "Barnabé makes the ground shake when he walks. But when the sky rumbles, he is the one shaking.",
    cover: "cover-indigo",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-chien-qui-gardait-les-chaussons",
    publishedAt: "2026-08-08",
    title: "Le chien qui gardait les chaussons",
    titleEn: "The dog who guarded the slippers",
    language: "fr",
    ageRange: "3-4",
    readingMinutes: 4,
    genre: "rigolote",
    theme: "famille",
    subTheme: "habitudes-rigolotes",
    character: "chien",
    tags: ["chien", "famille", "rigolo", "chaussons"],
    excerpt: "Chaque matin, la famille cherche ses chaussons. Chaque matin, ils sont tous au même endroit, sous le même chien.",
    excerptEn: "Every morning the family hunts for their slippers. Every morning they are all in the same place, under the same dog.",
    cover: "cover-sand",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "la-sirene-et-le-coquillage-qui-chante",
    publishedAt: "2026-06-30",
    title: "La sirène et le coquillage qui chante",
    titleEn: "The mermaid and the singing shell",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 6,
    genre: "fantastique",
    theme: "mer",
    subTheme: "trouver-son-propre-talent",
    character: "sirene",
    tags: ["sirène", "mer", "chant", "récif"],
    excerpt: "Dans une famille où tout le monde chante, Nérine n'a pas de voix. Puis elle trouve un coquillage qui chante à sa place.",
    excerptEn: "In a family where everyone sings, Nérine has no voice at all. Then she finds a shell that sings for her.",
    cover: "cover-sea",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-pirate-qui-avait-le-mal-de-mer",
    publishedAt: "2026-07-07",
    title: "Le pirate qui avait le mal de mer",
    titleEn: "The pirate who got seasick",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 6,
    genre: "rigolote",
    theme: "mer",
    subTheme: "assumer-son-defaut",
    character: "pirate",
    tags: ["pirate", "mer", "rigolo", "bateau"],
    excerpt: "Capitaine Barbe-Molle est un excellent pirate. Il a juste un tout petit défaut : la mer lui donne envie de vomir.",
    excerptEn: "Captain Soft-Beard is an excellent pirate. He just has one tiny flaw: the sea makes him want to be sick.",
    cover: "cover-dusk",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "la-licorne-des-lanternes-de-noel",
    publishedAt: "2026-07-14",
    title: "La licorne des lanternes de Noël",
    titleEn: "The unicorn of the Christmas lanterns",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 5,
    genre: "fete",
    theme: "noel",
    subTheme: "veillee-de-noel",
    character: "licorne",
    tags: ["noël", "licorne", "lanterne", "village"],
    excerpt: "Le soir de Noël, le vent souffle toutes les lanternes du village. Il en reste une seule allumée, très loin sur la colline.",
    excerptEn: "On Christmas Eve the wind blows out every lantern in the village. One single light is left, far away on the hill.",
    cover: "cover-night",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-petit-chevalier-et-le-pont-de-brume",
    publishedAt: "2026-07-21",
    title: "Le petit chevalier et le pont de brume",
    titleEn: "The little knight and the bridge of mist",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 6,
    genre: "aventure",
    theme: "courage",
    subTheme: "avancer-sans-voir",
    character: "chevalier",
    tags: ["chevalier", "courage", "brume", "pont"],
    excerpt: "Le pont existe. Aliénor le sait. Le problème, c'est que la brume est si épaisse qu'on ne voit pas ses propres pieds.",
    excerptEn: "The bridge is there. Aliénor knows it is. The trouble is that the mist is so thick she cannot see her own feet.",
    cover: "cover-indigo",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "qui-a-mange-les-fraises-du-jardin",
    publishedAt: "2026-07-28",
    title: "Qui a mangé les fraises du jardin ?",
    titleEn: "Who ate the strawberries?",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 5,
    genre: "mystere",
    theme: "animaux",
    subTheme: "petite-enquete",
    character: "dinosaure",
    tags: ["enquête", "jardin", "dinosaure", "fraises"],
    excerpt: "Vingt fraises hier soir. Zéro fraise ce matin. Pistache le petit dinosaure ouvre son carnet et commence l'enquête.",
    excerptEn: "Twenty strawberries last night. None this morning. Pistache the little dinosaur opens his notebook and begins the investigation.",
    cover: "cover-meadow",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-robot-qui-apprenait-a-dire-bonjour",
    publishedAt: "2026-08-04",
    title: "Le robot qui apprenait à dire bonjour",
    titleEn: "The robot who was learning to say hello",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 6,
    genre: "science-fiction",
    theme: "ecole",
    subTheme: "nouvel-eleve",
    character: "robot",
    tags: ["robot", "école", "bonjour", "amitié"],
    excerpt: "BIP-7 connaît quatre cents langues. Il ne comprend toujours pas pourquoi bonjour ne se dit jamais deux fois pareil.",
    excerptEn: "BIP-7 knows four hundred languages. He still cannot work out why hello is never said the same way twice.",
    cover: "cover-mint",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "une-journee-avec-la-boulangere",
    publishedAt: "2026-08-07",
    title: "Une journée avec la boulangère",
    titleEn: "A day with the baker",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 5,
    genre: "metier",
    theme: "famille",
    subTheme: "metier-de-la-nuit",
    character: "enfant-fille",
    tags: ["métier", "boulangère", "pain", "famille"],
    excerpt: "Zoé a le droit de passer une journée entière à la boulangerie de tante Marion. Le problème, c'est que la journée commence à quatre heures du matin.",
    excerptEn: "Zoé is allowed to spend a whole day at Aunt Marion's bakery. The trouble is that the day starts at four in the morning.",
    cover: "cover-peach",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
  ...
  {
    slug: "le-dragon-pompier",
    publishedAt: "2026-08-11",
    title: "Le dragon pompier",
    titleEn: "The firefighter dragon",
    language: "fr",
    ageRange: "5-6",
    readingMinutes: 6,
    genre: "metier",
    theme: "courage",
    subTheme: "choisir-son-metier",
    character: "dragon",
    tags: ["dragon", "pompier", "courage", "métier"],
    excerpt: "Un dragon crache du feu. C'est écrit partout. Braise, lui, veut faire exactement le contraire.",
    excerptEn: "A dragon breathes fire. It says so everywhere. Braise wants to do exactly the opposite.",
    cover: "cover-sand",
    rating: 0,
    ratingCount: 0,
    favoritesCount: 0,
...
const STORY_CONTENT: Record<string, StoryContent> = {
  ...
  "la-licorne-qui-avait-perdu-ses-couleurs": {
    body: [
      "Iris la licorne se réveilla un matin et sut tout de suite que quelque chose n'allait pas. Sa crinière, d'habitude rose, bleue et dorée, était devenue blanche. Toute blanche, comme un nuage qui aurait oublié le ciel.",
      "« Mes couleurs ! » cria Iris. Elle galopa jusqu'à la mare pour se regarder dedans. C'était bien vrai : plus une seule couleur nulle part. Même sa corne, qui brillait d'habitude comme un matin d'été, était grise et toute terne.",
      "Iris s'assit dans la prairie et baissa la tête très bas. Une licorne sans couleurs, ça ne peut pas exister, pensa-t-elle. Alors elle alla se cacher derrière le grand buisson d'églantines, tout au fond du pré, pour que personne ne la voie comme ça.",
      "Mais ses amis la cherchaient déjà. Le premier arriva en trottinant : c'était Pablo l'écureuil. « Te voilà ! J'ai gardé la plus belle noisette de l'automne rien que pour toi. » Il la posa devant elle et ne remarqua rien du tout.",
      "Puis vint Nina la mésange, qui se percha sur son oreille et chanta la chanson qu'Iris préférait, celle avec les trois petits sifflements à la fin. Puis Gros-Sabot le poney, qui ne dit pas un mot et posa simplement sa tête contre la sienne, parce que parfois c'est exactement ce qu'il faut faire.",
      "Iris releva doucement les yeux. Sur sa crinière, là où Pablo avait posé sa noisette, il y avait une mèche dorée. Là où Nina avait chanté, une mèche bleue. Et là où Gros-Sabot avait appuyé sa tête, une grande mèche rose.",
      "« Vous m'avez rendu mes couleurs ! » souffla Iris. « Non, dit Nina en penchant sa petite tête. Elles étaient là depuis le début. Elles attendaient juste que quelqu'un vienne te regarder. »",
      "Depuis ce jour, quand Iris se sent un peu grise, elle ne va plus se cacher derrière le buisson. Elle va voir ses amis. Les couleurs, ça ne se perd jamais vraiment : ça revient dès que quelqu'un prend le temps de nous regarder.",
    ],
    quiz: [
      {
        question: "Que découvre Iris en se réveillant ?",
        choices: ["Sa crinière est devenue toute blanche", "Sa corne a disparu", "Elle a grandi"],
        answer: 0,
        explanation: "Sa crinière rose, bleue et dorée est devenue blanche comme un nuage.",
      },
      {
        question: "Qui arrive le premier pour voir Iris ?",
        choices: ["Nina la mésange", "Pablo l'écureuil", "Gros-Sabot le poney"],
        answer: 1,
        explanation: "Pablo l'écureuil arrive le premier, avec la plus belle noisette de l'automne.",
      },
      {
        question: "Comment les couleurs d'Iris reviennent-elles ?",
        choices: ["Quand ses amis viennent la voir", "Quand elle se lave dans la mare", "Quand le soleil se lève"],
        answer: 0,
        explanation: "Chaque ami lui rend une mèche de couleur, simplement en venant la voir.",
      },
    ],
    glossary: [
      { word: "crinière", definition: "Les longs cheveux qui poussent sur le cou des chevaux et des licornes." },
      { word: "corne", definition: "La pointe magique qui pousse sur le front d'une licorne." },
      { word: "prairie", definition: "Un grand champ d'herbe verte, plein de fleurs au printemps." },
    ],
  },
  "le-loup-qui-voulait-juste-un-ami": {
    body: [
      "Dans la forêt, tout le monde connaissait Gris le loup. Ou plutôt, tout le monde connaissait ses oreilles pointues, sa grande ombre et le bruit de ses pattes sur les feuilles. Personne ne connaissait vraiment Gris.",
      "Le soir, dans sa clairière, Gris s'entraînait. Il se plantait devant un tronc d'arbre et disait, très poliment : « Bonjour, je m'appelle Gris. Est-ce que tu veux jouer ? » Le tronc ne répondait jamais, mais au moins il ne se sauvait pas.",
      "Le lendemain, Gris essayait pour de vrai. Il voyait un lapin, il ouvrait la bouche, et le lapin partait déjà. Il voyait trois mésanges, il faisait un pas, et les trois mésanges devenaient trois points dans le ciel.",
      "« C'est ma voix », pensa Gris. Alors il parla tout doucement. Ça ne marcha pas. « C'est ma taille », pensa-t-il ensuite. Alors il se coucha dans l'herbe pour être tout petit. Ça ne marcha pas non plus.",
      "Un soir de pluie, Gris entendit un tout petit reniflement sous une fougère. C'était Pruneau, un hérisson trempé, perdu et pas très content. « Bonjour, dit Gris sans réfléchir. Tu veux te mettre à l'abri sous mon ventre ? Il est chaud. »",
      "Pruneau leva la tête. Il regarda les grandes dents, les oreilles pointues, l'ombre immense. Puis il regarda les yeux, qui étaient inquiets et gentils. Et comme il pleuvait vraiment très fort, il dit : « D'accord. »",
      "Ils restèrent là toute la nuit, sans presque rien dire, à écouter la pluie tomber sur les fougères. Au matin, Pruneau bâilla et demanda : « Tu fais quoi, demain ? »",
      "Gris ne répondit pas tout de suite, parce qu'il avait la gorge un peu serrée. Il avait cherché un ami partout dans la forêt, en s'entraînant chaque soir. Il avait juste fallu qu'il oublie de s'entraîner et qu'il tende son ventre chaud à quelqu'un qui avait froid.",
    ],
    quiz: [
      {
        question: "Devant quoi Gris s'entraîne-t-il à dire bonjour ?",
        choices: ["Devant un tronc d'arbre", "Devant un miroir", "Devant sa maman"],
        answer: 0,
        explanation: "Il s'entraîne devant un tronc d'arbre, qui ne répond pas mais ne se sauve pas.",
      },
      {
        question: "Qui Gris trouve-t-il sous la fougère ?",
        choices: ["Un lapin", "Pruneau le hérisson", "Une mésange"],
        answer: 1,
        explanation: "Il trouve Pruneau, un hérisson trempé et perdu sous la pluie.",
      },
      {
        question: "Pourquoi Pruneau accepte-t-il de rester ?",
        choices: ["Parce qu'il pleut très fort et que le ventre de Gris est chaud", "Parce qu'il a peur de partir", "Parce qu'il veut manger"],
        answer: 0,
        explanation: "Il regarde les yeux gentils de Gris, et comme il pleut très fort, il accepte.",
      },
    ],
    glossary: [
      { word: "clairière", definition: "Un endroit sans arbres au milieu de la forêt, où le ciel se voit." },
      { word: "fougère", definition: "Une grande plante verte aux feuilles découpées, qui pousse à l'ombre." },
      { word: "hérisson", definition: "Un petit animal couvert de piquants, qui se roule en boule quand il a peur." },
    ],
  },
  "nino-part-a-l-ecole-des-petits": {
    body: [
      "Ce matin, il y a un cartable tout neuf sur la chaise de Nino. Il est bleu, il sent le plastique, et il est presque aussi grand que Nino. Dedans, il n'y a rien du tout. Enfin, presque rien.",
      "Parce que Nino a glissé son doudou tout au fond, sous le goûter. « Il ne faut pas qu'on le voie, chuchote-t-il. Mais il faut qu'il soit là. » Maman fait oui de la tête, et elle ne dit rien à personne.",
      "Devant l'école, il y a beaucoup de bruit, beaucoup de parents et beaucoup de petits qui tiennent une main très fort. Nino tient celle de Maman très fort aussi. Peut-être même un peu trop fort.",
      "La maîtresse s'appelle Salomé. Elle s'accroupit pour être à la hauteur de Nino et elle dit : « Bonjour Nino. Tu veux entrer avec moi, ou tu préfères encore une minute ? » Nino réfléchit. « Encore une minute. » « D'accord », dit Salomé.",
      "Une minute, c'est court. Mais c'est déjà mieux que tout de suite. Quand elle est finie, Nino lâche la main de Maman, tout doucement, un doigt après l'autre.",
      "Dedans, il y a des tables minuscules, un tapis rond, et une boîte pleine de voitures. Il y a aussi une petite fille qui pleure, et Nino lui prête une voiture rouge sans rien dire, parce qu'il sait exactement ce qu'elle ressent.",
      "L'après-midi, dans la cour, sous le préau, Nino ouvre son cartable pour vérifier. Le doudou est là, entre le goûter et la boîte à mouchoirs, exactement où il l'avait mis.",
      "Le soir, Maman demande : « Tu as sorti ton doudou ? » Nino réfléchit et fait non de la tête. Il n'en a pas eu besoin. Mais savoir qu'il était là, tout au fond, ça l'a aidé toute la journée.",
    ],
    quiz: [
      {
        question: "Qu'est-ce que Nino cache au fond de son cartable ?",
        choices: ["Son doudou", "Une voiture rouge", "Son goûter"],
        answer: 0,
        explanation: "Il glisse son doudou tout au fond, sous le goûter, pour que personne ne le voie.",
      },
      {
        question: "Que propose la maîtresse Salomé à Nino ?",
        choices: ["D'entrer avec elle ou d'attendre encore une minute", "De rentrer à la maison", "De ranger son cartable"],
        answer: 0,
        explanation: "Elle s'accroupit et lui laisse le choix : entrer avec elle, ou une minute de plus.",
      },
      {
        question: "Que fait Nino quand une petite fille pleure ?",
        choices: ["Il lui prête une voiture rouge", "Il appelle la maîtresse", "Il pleure aussi"],
        answer: 0,
        explanation: "Il lui prête une voiture rouge sans rien dire, parce qu'il sait ce qu'elle ressent.",
      },
    ],
    glossary: [
      { word: "cartable", definition: "Le sac qu'on porte sur le dos pour emporter ses affaires à l'école." },
      { word: "maîtresse", definition: "La grande personne qui s'occupe des enfants et leur apprend des choses à l'école." },
      { word: "préau", definition: "La partie couverte de la cour, où on peut jouer même quand il pleut." },
    ],
  },
  "le-gouter-surprise-de-pilou": {
    body: [
      "Ce matin, Pilou s'est réveillé avec une idée très importante dans la tête : aujourd'hui, il a trois ans. Il l'a répété tout bas trois fois pour être bien sûr. Trois ans.",
      "Il est sorti de sa chambre en courant. Maman Lapin lisait. « Bonjour Pilou », a-t-elle dit, sans rien ajouter du tout. Pas de « joyeux anniversaire ». Rien.",
      "À midi, il y a eu des carottes, comme tous les jours. L'après-midi, Papa Lapin est parti faire des courses et il a dit : « Ne va surtout pas dans le grand terrier du fond. » Pilou a fait oui de la tête, et il a trouvé ça bizarre.",
      "Alors Pilou est allé s'asseoir tout seul devant la porte. Il a compté les nuages. Il en a compté onze. « Ils ont oublié », a-t-il dit tout bas à un caillou, parce qu'il n'y avait personne d'autre.",
      "Le caillou n'a pas répondu, mais le vent a apporté une drôle d'odeur. Une odeur de gâteau aux noisettes. Une odeur qui venait, justement, du grand terrier du fond.",
      "Pilou s'est approché sur la pointe des pattes. La porte s'est ouverte d'un coup et vingt voix ont crié en même temps : « SURPRISE ! » Il y avait une guirlande, un gâteau, ses cousins, ses voisins et même la vieille taupe d'à côté.",
      "« On a fait semblant toute la journée, a dit Maman Lapin. C'était très, très dur. » « J'ai failli tout dire au petit déjeuner », a avoué Papa Lapin.",
      "Pilou a soufflé ses trois bougies d'un seul coup. Il avait cru qu'on l'avait oublié, alors qu'en vrai, tout le monde pensait à lui depuis le matin, en silence. C'est ça, une surprise : de l'amour qui se cache un petit moment.",
    ],
    quiz: [
      {
        question: "Quel âge a Pilou aujourd'hui ?",
        choices: ["Trois ans", "Deux ans", "Cinq ans"],
        answer: 0,
        explanation: "Pilou se réveille avec une idée très importante : aujourd'hui, il a trois ans.",
      },
      {
        question: "Où Papa Lapin interdit-il d'aller ?",
        choices: ["Dans le grand terrier du fond", "Dans le jardin", "Chez la taupe"],
        answer: 0,
        explanation: "Papa Lapin lui interdit le grand terrier du fond, et c'est justement là qu'est la surprise.",
      },
      {
        question: "Qu'est-ce qui met Pilou sur la piste ?",
        choices: ["Une odeur de gâteau aux noisettes", "Un bruit dans la cuisine", "Une lettre sur la porte"],
        answer: 0,
        explanation: "Le vent apporte une odeur de gâteau aux noisettes venant du terrier du fond.",
      },
    ],
    glossary: [
      { word: "terrier", definition: "La maison creusée sous la terre où vivent les lapins et les renards." },
      { word: "guirlande", definition: "Une longue décoration en papier ou en fleurs qu'on accroche pour faire la fête." },
      { word: "taupe", definition: "Un petit animal noir qui vit sous la terre et voit très mal." },
    ],
  },
  "le-sapin-qui-n-aimait-pas-les-boules": {
    body: [
      "Au bord du chemin, il y avait un petit sapin qui avait un problème. Chaque année, au mois de décembre, les gens du village venaient l'habiller de boules brillantes. Et chaque année, au bout de deux heures, toutes les boules étaient par terre.",
      "Le sapin les faisait tomber. Pas méchamment. Il secouait juste un peu ses aiguilles, comme quand on a une écharpe qui gratte, et plouf, les boules glissaient dans la neige.",
      "« Il est capricieux, ce sapin », disaient les gens en repartant. Le sapin ne pouvait pas répondre, bien sûr. Mais s'il avait pu, il aurait dit : « Ça me chatouille. »",
      "Un soir, une petite fée nommée Brume se posa sur la branche du haut. Elle était minuscule, elle avait froid, et elle cherchait un endroit où dormir. « Pourquoi tu n'es pas décoré, toi ? » demanda-t-elle.",
      "Le sapin secoua doucement ses aiguilles. Une dernière boule oubliée tomba dans la neige, ploc. Brume comprit tout de suite. « Ah, dit-elle. Tu n'aimes pas ce qui accroche. »",
      "Alors Brume fit quelque chose que personne n'avait essayé. Elle ne posa rien sur le sapin. Elle souffla, très doucement, et le givre dessina des étoiles sur chaque aiguille. Puis elle appela ses amies, et les lucioles vinrent se poser où elles voulaient, sans être attachées.",
      "Au matin, tout le village s'arrêta devant le petit sapin. Il brillait plus que tous les autres, avec ses étoiles de givre et ses lumières vivantes qui bougeaient un peu quand le vent passait.",
      "« Comment il a fait ? » demanda un enfant. Personne ne sut répondre. Mais le sapin, lui, savait : on ne l'avait pas décoré comme les autres, on l'avait décoré comme lui.",
    ],
    quiz: [
      {
        question: "Que fait le petit sapin avec les boules ?",
        choices: ["Il les fait tomber en secouant ses aiguilles", "Il les casse", "Il les cache dans la neige"],
        answer: 0,
        explanation: "Il secoue un peu ses aiguilles, et les boules glissent dans la neige.",
      },
      {
        question: "Pourquoi le sapin fait-il tomber les boules ?",
        choices: ["Ça le chatouille", "Il n'aime pas Noël", "Elles sont trop lourdes"],
        answer: 0,
        explanation: "Il n'est pas capricieux : les boules le chatouillent, comme une écharpe qui gratte.",
      },
      {
        question: "Comment Brume décore-t-elle le sapin ?",
        choices: ["Avec du givre et des lucioles", "Avec des boules plus petites", "Avec des rubans"],
        answer: 0,
        explanation: "Elle souffle du givre en forme d'étoiles et appelle les lucioles, qui se posent librement.",
      },
    ],
    glossary: [
      { word: "aiguilles", definition: "Les petites feuilles pointues et vertes du sapin, fines comme des piquants." },
      { word: "givre", definition: "La fine glace blanche qui se dépose sur les plantes les matins très froids." },
      { word: "lucioles", definition: "De petits insectes qui font de la lumière dans le noir, comme des lampes volantes." },
    ],
  },
  "le-dinosaure-qui-avait-peur-du-tonnerre": {
    body: [
      "Barnabé était un dinosaure très grand. Quand il marchait, les flaques faisaient des ronds et les petits cailloux sautaient. Il n'avait peur de rien du tout. Sauf d'une seule chose.",
      "Le tonnerre. Dès que le ciel faisait BROUM, Barnabé se cachait derrière le plus gros rocher qu'il trouvait. Ce qui était compliqué, parce qu'il était plus grand que la plupart des rochers.",
      "Ce soir-là, l'orage arriva juste avant le coucher. D'abord le vent. Puis une grande lumière blanche dans le ciel. Puis, quelques secondes plus tard : BROUM.",
      "Barnabé fila se cacher, mais sa queue dépassait, ses pattes dépassaient, et son museau dépassait aussi. Maman Dinosaure vint s'asseoir à côté de lui, tranquillement, comme si de rien n'était.",
      "« Tu sais ce que c'est, le tonnerre ? » demanda-t-elle. « C'est un monstre », dit Barnabé, les yeux fermés. « Non. C'est juste le bruit que fait l'éclair. La lumière va très vite, le bruit va moins vite. Le bruit court derrière, voilà tout. »",
      "Elle lui apprit un jeu. « Quand tu vois l'éclair, tu comptes. Un, deux, trois. Quand tu entends BROUM, tu t'arrêtes. Plus le nombre est grand, plus l'orage est loin. »",
      "Alors ils comptèrent ensemble. La première fois : un, deux. La deuxième fois : un, deux, trois, quatre. Puis un, deux, trois, quatre, cinq, six, sept.",
      "« Il s'en va ! » cria Barnabé, tout content d'avoir gagné. Il s'endormit avant le dixième éclair. Le tonnerre n'avait pas changé du tout : c'est Barnabé qui avait quelque chose à faire pendant qu'il grondait.",
    ],
    quiz: [
      {
        question: "De quoi Barnabé a-t-il peur ?",
        choices: ["Du tonnerre", "Du noir", "De l'eau"],
        answer: 0,
        explanation: "Barnabé n'a peur de rien, sauf du tonnerre qui fait BROUM.",
      },
      {
        question: "Qu'est-ce que le tonnerre, d'après Maman Dinosaure ?",
        choices: ["Le bruit que fait l'éclair", "Un monstre dans les nuages", "La pluie qui tombe"],
        answer: 0,
        explanation: "La lumière va vite, le bruit va moins vite : le tonnerre court derrière l'éclair.",
      },
      {
        question: "À quoi sert le jeu de compter ?",
        choices: ["À savoir si l'orage s'éloigne", "À faire venir la pluie", "À s'endormir plus vite"],
        answer: 0,
        explanation: "Plus le nombre entre l'éclair et le BROUM est grand, plus l'orage est loin.",
      },
    ],
    glossary: [
      { word: "tonnerre", definition: "Le gros bruit qui roule dans le ciel pendant un orage." },
      { word: "éclair", definition: "La grande lumière blanche qui zigzague dans le ciel avant le tonnerre." },
      { word: "orage", definition: "Un moment où le ciel devient noir, avec du vent, de la pluie et du tonnerre." },
    ],
  },
  "le-chien-qui-gardait-les-chaussons": {
    body: [
      "Dans la maison des Berger, il y avait quatre personnes et un chien. Les quatre personnes s'appelaient Papa, Maman, Louise et Tom. Le chien s'appelait Biscotte, et Biscotte avait une passion très sérieuse : les chaussons.",
      "Chaque nuit, pendant que tout le monde dormait, Biscotte faisait sa tournée. Elle allait chercher le chausson bleu de Papa. Puis les deux chaussons roses de Maman. Puis celui de Louise, puis celui de Tom, puis l'autre de Tom, qui était toujours plus loin que le premier.",
      "Elle les rapportait un par un dans son panier, elle les rangeait en tas bien rond, et elle se couchait dessus. Voilà. C'était son travail de la nuit.",
      "Le matin, c'était toujours la même chanson. « Où sont mes chaussons ? » criait Papa depuis l'escalier. « Sous le chien ! » répondaient les trois autres en même temps.",
      "Alors tout le monde arrivait dans la cuisine, et il fallait négocier. Biscotte ne grognait pas, ne mordait pas, ne bougeait pas non plus. Elle faisait juste semblant de dormir très profondément, ce qui est la meilleure défense connue chez les chiens.",
      "Un jour, Louise décida de mener l'enquête. Elle demanda à la vétérinaire pourquoi Biscotte volait les chaussons. La vétérinaire réfléchit et dit : « Elle ne les vole pas. Elle les rassemble. »",
      "« Un chausson, ça garde l'odeur de la personne qui le met, expliqua-t-elle. Biscotte n'arrive pas à vous mettre tous les quatre dans son panier. Alors elle prend ce qui vous ressemble le plus, et elle dort au milieu. »",
      "Ce soir-là, Louise posa exprès son chausson tout près du panier, pour lui faciliter le travail. Toute la famille fit pareil, sans se le dire. Le lendemain matin, personne ne trouva ses chaussons, et pour la première fois, ça fit rire tout le monde.",
    ],
    quiz: [
      {
        question: "Que fait Biscotte pendant la nuit ?",
        choices: ["Elle rassemble tous les chaussons dans son panier", "Elle garde la porte", "Elle mange les chaussons"],
        answer: 0,
        explanation: "Elle fait sa tournée et rapporte chaque chausson en tas bien rond dans son panier.",
      },
      {
        question: "Comment Biscotte se défend-elle le matin ?",
        choices: ["Elle fait semblant de dormir très profondément", "Elle grogne", "Elle se sauve dans le jardin"],
        answer: 0,
        explanation: "Elle ne grogne pas et ne bouge pas : elle fait semblant de dormir, la meilleure défense connue.",
      },
      {
        question: "Pourquoi Biscotte rassemble-t-elle les chaussons ?",
        choices: ["Ils gardent l'odeur de sa famille", "Ils sont doux à mâcher", "Elle veut les cacher"],
        answer: 0,
        explanation: "Elle ne peut pas mettre les quatre personnes dans son panier, alors elle prend ce qui leur ressemble le plus.",
      },
    ],
    glossary: [
      { word: "chausson", definition: "La chaussure toute douce qu'on met à la maison pour avoir les pieds au chaud." },
      { word: "panier", definition: "La corbeille où dort un chien ou un chat, souvent garnie d'un coussin." },
      { word: "vétérinaire", definition: "Le docteur des animaux, qui les soigne et sait comment ils vivent." },
    ],
  },
  "la-sirene-et-le-coquillage-qui-chante": {
    body: [
      "Chez les sirènes du récif bleu, on chantait pour tout. Pour appeler les dauphins, pour endormir les bébés, pour dire bonjour aux baleines qui passaient au large. Chanter, c'était comme respirer.",
      ...
      "Alors elle passait ses journées loin du récif, à fouiller le sable. C'est là, un matin, sous une vieille ancre rouillée, qu'elle trouva le coquillage. Il était nacré, tordu, et pas très joli.",
      "Nérine souffla dedans, comme on souffle dans une bougie. Et le coquillage se mit à chanter. Pas un sifflement : une vraie voix, ronde et chaude, qui montait et descendait comme la houle.",
      "Le soir du concert, Nérine cacha le coquillage derrière son dos. Quand vint son tour, elle souffla. La voix s'éleva au-dessus du récif, et tout le monde se tut. Même les vieilles tortues arrêtèrent de mâcher.",
      "Le récif entier retenait son souffle. Les hippocampes avaient arrêté de tourner autour des algues. Tout au fond, deux crabes qui se disputaient depuis le matin s'étaient interrompus au milieu d'une pince levée.",
      ...
      "Elle attendit que le silence revienne. Puis elle ramena ses mains devant elle et montra le coquillage à tout le monde. « Ce n'est pas moi, dit-elle avec son petit son plat. C'est lui. Je l'ai trouvé sous l'ancre. »",
      "Il y eut un long moment sans rien. Puis la plus vieille sirène du récif s'avança, prit le coquillage, le tourna dans la lumière et demanda : « Tu l'as trouvé toute seule ? Sous le sable ? »",
      ...
      "« Oui », dit Nérine. « Nous sommes cent dans ce récif, dit la vieille sirène. Cent à passer devant cette ancre depuis cinquante ans. Aucune de nous n'a jamais rien trouvé du tout. »",
      ...
      "On lui construisit un petit atelier dans une anfractuosité du récif, avec des étagères de sable tassé. Chaque objet y est posé sur un lit d'algues, avec une petite étiquette en écaille indiquant l'endroit exact où il a été trouvé.",
      "Elle ne chante toujours pas très bien. Mais quand le concert des marées commence, c'est elle qui apporte les voix. Un talent, ce n'est pas toujours celui de la famille : parfois il attend, tout seul, sous une vieille ancre.",
    ],
    quiz: [
      {
        question: "Quel est le problème de Nérine ?",
        choices: ["Sa voix ne fait qu'un petit son plat", "Elle a peur de l'eau profonde", "Elle ne connaît pas les chansons"],
        answer: 0,
        explanation: "Quand elle ouvre la bouche, il en sort un seul son plat, comme une porte qui grince.",
      },
      {
        question: "Où Nérine trouve-t-elle le coquillage ?",
        choices: ["Sous une vieille ancre rouillée", "Dans le nid d'une tortue", "Au fond d'une grotte"],
        answer: 0,
        explanation: "Elle le trouve un matin dans le sable, sous une vieille ancre rouillée.",
      },
      {
        question: "Que fait Nérine après les applaudissements ?",
        choices: ["Elle montre le coquillage et dit la vérité", "Elle se sauve du concert", "Elle recommence à chanter"],
        answer: 0,
        explanation: "Elle ramène ses mains devant elle et explique que la voix vient du coquillage.",
      },
      {
        question: "Quel est le vrai talent de Nérine ?",
        choices: ["Trouver ce que personne d'autre ne voit", "Nager plus vite que ses sœurs", "Parler aux baleines"],
        answer: 0,
        explanation: "Cent sirènes passaient devant cette ancre depuis cinquante ans sans rien voir.",
      },
    ],
    glossary: [
      { word: "récif", definition: "Une longue barrière de rochers et de corail, juste sous la surface de la mer." },
      { word: "houle", definition: "Le mouvement lent et régulier de la mer, qui monte et descend sans casser." },
      { word: "ancre", definition: "La lourde pièce de métal qu'on jette au fond pour empêcher un bateau de partir." },
    ],
  },
  "le-pirate-qui-avait-le-mal-de-mer": {
    body: [
      ...
      "Dès que le bateau bougeait un peu, son visage passait du rose au blanc, puis du blanc au vert pâle, comme une pomme pas mûre. Alors il s'accrochait au bastingage et il regardait l'horizon très fort, en pensant à autre chose.",
      ...
      "Un jour de grosse houle, le capitaine réfléchit tellement fort qu'il ne put plus lâcher le bastingage du tout. Et c'est exactement ce jour-là que la vigie cria : « Récif droit devant ! »",
      ...
      "Le second n'en revenait pas. Depuis trois ans qu'il naviguait avec lui, il avait toujours cru que le capitaine s'accrochait au bastingage par habitude, comme d'autres se rongent les ongles.",
      "Ce soir-là, l'équipage installa un hamac au milieu du bateau, à l'endroit précis où ça bouge le moins. Puis ils accrochèrent la boussole juste au-dessus, à hauteur des yeux.",
      "« Vous êtes notre vigie, capitaine, dit le second. La meilleure de tous les océans. Vous ne quittez jamais l'horizon des yeux. »",
    ...
    quiz: [
      {
        question: "Quel est le défaut du capitaine Barbe-Molle ?",
        choices: ["Il a le mal de mer", "Il ne sait pas nager", "Il a peur du noir"],
        answer: 0,
        explanation: "Dès que le bateau bouge, il devient vert pâle comme une pomme pas mûre.",
      },
      {
        question: "Que dit l'équipage pour le protéger ?",
        choices: ["Que le capitaine réfléchit très fort", "Que le capitaine dort", "Que le capitaine compte les mouettes"],
        answer: 0,
        explanation: "Le second répète que le capitaine réfléchit et qu'il ne faut pas le déranger.",
      },
      {
        question: "Comment le capitaine sauve-t-il le bateau du récif ?",
        choices: ["Il crie les manœuvres sans se retourner", "Il prend lui-même le gouvernail", "Il jette l'ancre"],
        answer: 0,
        explanation: "Toujours plié en deux, il crie tribord, puis bâbord toute, comptez jusqu'à six.",
      },
      {
        question: "Pourquoi avait-il vu le récif avant les autres ?",
        choices: ["Il regarde l'horizon toute la journée", "Il a une longue-vue magique", "Le perroquet l'avait prévenu"],
        answer: 0,
        explanation: "Son mal de mer l'oblige à fixer l'horizon, donc il voit tout arriver en premier.",
      },
    ],
    glossary: [
      { word: "bastingage", definition: "La barrière tout autour du pont d'un bateau, à laquelle on s'accroche." },
      { word: "vigie", definition: "La personne chargée de surveiller la mer et de prévenir quand elle voit quelque chose." },
      { word: "boussole", definition: "Le petit instrument dont l'aiguille montre toujours le nord." },
    ],
  },
  "la-licorne-des-lanternes-de-noel": {
    body: [
      "Chaque 24 décembre, le village de Fontclaire faisait la veillée des lanternes. Tout le monde sortait dans la nuit avec une lanterne en papier, et on marchait ensemble jusqu'à la vieille chapelle, en haut du chemin.",
      ...
      "Adèle s'approcha et tendit sa lanterne. La licorne pencha la tête et toucha la mèche du bout de sa corne. La petite flamme repartit d'un coup, plus jaune et plus ronde qu'avant.",
      ...
      "On raconte encore la veillée où toutes les lanternes se sont éteintes. On oublie souvent la fin : ce n'est pas la licorne qui a sauvé la fête, c'est Adèle, qui a levé le doigt et qui est montée la première dans le noir.",
    ],
    quiz: [
      {
        question: "Que se passe-t-il au début de la veillée ?",
        choices: ["Un coup de vent éteint toutes les lanternes", "Il se met à neiger très fort", "La chapelle est fermée"],
        answer: 0,
        explanation: "Un coup de vent traverse la rue et éteint toutes les lanternes en même temps.",
      },
      {
        question: "Qui remarque la lumière restée allumée ?",
        choices: ["La petite Adèle", "Le boulanger", "Le père d'Adèle"],
        answer: 0,
        explanation: "Adèle lève le doigt vers le haut de la colline et montre la lumière à tout le monde.",
      },
      {
        question: "Qu'est-ce que cette lumière, en réalité ?",
        choices: ["La corne d'une licorne", "Une lanterne oubliée", "Une étoile très basse"],
        answer: 0,
        explanation: "C'est une longue corne blanche, sur le front d'une licorne assise dans la neige.",
      },
      {
        question: "Qui a vraiment sauvé la veillée ?",
        choices: ["Adèle, en montant la première dans le noir", "La licorne, en rallumant les lanternes", "Le vent, en tombant"],
        answer: 0,
        explanation: "Sans Adèle qui lève le doigt et part devant, tout le village serait rentré chez lui.",
      },
    ],
    glossary: [
      { word: "veillée", definition: "Une soirée où l'on reste ensemble tard, pour fêter ou se raconter des histoires." },
      { word: "chapelle", definition: "Une toute petite église, souvent posée à l'écart du village." },
      { word: "mèche", definition: "Le petit fil au milieu d'une bougie, celui qui prend feu quand on l'allume." },
    ],
  },
  "le-petit-chevalier-et-le-pont-de-brume": {
    body: [
      "Aliénor avait onze ans et une armure trop grande pour elle. Elle était écuyère, ce qui veut dire chevalier pas encore fini. Pour devenir chevalier pour de vrai, il fallait rapporter le sceau du monastère, de l'autre côté de la vallée.",
      "Le seul chemin passait par le pont de pierre. Et le pont de pierre, tout le monde le savait, était toujours noyé dans la brume.",
      "Quand Aliénor arriva au bord, elle ne vit rien du tout. Pas la rivière en dessous. Pas l'autre rive. Pas même le début du pont. Juste du blanc, épais comme du lait.",
      "Son maître d'armes lui avait donné un seul conseil, la veille au soir, en nettoyant son épée : « Sur ce pont, tes yeux vont te mentir. Ne les écoute pas trop. » Aliénor avait trouvé ça bien mystérieux et pas très utile.",
      "Elle tendit le pied. Il y avait de la pierre. Elle avança d'un pas, puis de deux. Au troisième pas, elle ne voyait déjà plus la rive qu'elle venait de quitter.",
      "C'est là que la peur arriva. Pas d'un coup : tout doucement, en montant depuis les genoux. Aliénor s'arrêta net au milieu du blanc, sans savoir s'il restait dix pas ou cent.",
      "Elle pensa faire demi-tour. Mais demi-tour, dans la brume, ça veut dire choisir une direction au hasard. Alors elle s'assit sur le pont, ferma les yeux, et écouta.",
      "Elle se souvint alors d'une chose que disent les vieux soldats : quand on ne voit plus, on n'est pas aveugle, on est juste occupé à regarder. Elle décida d'arrêter de regarder, ce qui est beaucoup plus difficile qu'il n'y paraît.",
      "D'abord elle n'entendit que son cœur. Puis, en dessous, très loin, la rivière. Un bruit d'eau régulier, qui venait de la gauche et filait vers la droite.",
      "Elle rouvrit les yeux et comprit quelque chose d'important : elle ne pouvait pas voir le pont, mais elle pouvait entendre la rivière. Et tant que la rivière passait sous elle de gauche à droite, c'est qu'elle marchait bien en travers, donc dans le bon sens.",
      "Alors Aliénor se releva et repartit. Un pas, écouter. Un pas, écouter. Quand le bruit de l'eau glissait un peu trop d'un côté, elle corrigeait, et elle repartait.",
      "Elle mit un genou en terre pour être sûre de ne pas dévier, posa la main à plat sur la pierre froide et sentit, sous sa paume, le tremblement très léger que fait un pont quand l'eau passe dessous.",
      "Ça prit très longtemps. Beaucoup plus longtemps que de traverser en courant. Mais au bout d'un moment, son pied ne trouva plus de pierre : il trouva de l'herbe mouillée.",
      "Au monastère, le vieux moine qui lui remit le sceau lui demanda si elle avait eu peur. « Tout le temps », répondit Aliénor. Le moine hocha la tête, l'air content. « Bien. Les autres me disent toujours que non. »",
      "Elle avait de la brume dans les cheveux, de la brume sur son armure trop grande, et les jambes qui tremblaient un peu. Le moine la regarda longuement avant de dire quoi que ce soit.",
      "Sur le chemin du retour, elle retraversa le pont sans s'arrêter une seule fois. Le courage, ce n'est pas de voir clair : c'est de trouver ce qu'on peut encore écouter quand on ne voit plus rien.",
    ],
    quiz: [
      {
        question: "Que doit rapporter Aliénor pour devenir chevalier ?",
        choices: ["Le sceau du monastère", "L'épée du roi", "Une pierre de la rivière"],
        answer: 0,
        explanation: "Elle doit rapporter le sceau du monastère, de l'autre côté de la vallée.",
      },
      {
        question: "Pourquoi s'arrête-t-elle au milieu du pont ?",
        choices: ["La peur monte et elle ne voit plus les deux rives", "Le pont est cassé", "Elle a perdu son armure"],
        answer: 0,
        explanation: "Elle ne voit plus la rive de départ et ne sait pas s'il reste dix pas ou cent.",
      },
      {
        question: "Qu'est-ce qui lui indique la bonne direction ?",
        choices: ["Le bruit de la rivière, qui va de gauche à droite", "Le soleil derrière la brume", "Les traces sur la pierre"],
        answer: 0,
        explanation: "Tant que l'eau passe sous elle de gauche à droite, c'est qu'elle traverse bien en travers.",
      },
      {
        question: "Que répond Aliénor quand le moine lui demande si elle a eu peur ?",
        choices: ["« Tout le temps »", "« Jamais »", "« Un tout petit peu »"],
        answer: 0,
        explanation: "Elle répond « Tout le temps », et le moine trouve ça très bien : les autres disent toujours non.",
      },
    ],
    glossary: [
      { word: "écuyère", definition: "Une jeune personne qui apprend le métier de chevalier, en aidant un chevalier plus âgé." },
      { word: "brume", definition: "Un brouillard léger et blanc qui flotte au ras du sol et cache tout." },
      { word: "sceau", definition: "Un petit cachet gravé qu'on presse dans la cire pour signer un document important." },
    ],
  },
  "qui-a-mange-les-fraises-du-jardin": {
    body: [
      "Pistache était un dinosaure vert, pas très grand, avec un carnet et un crayon toujours accrochés au cou. Ce matin-là, il arriva devant son carré de fraises et resta la bouche ouverte.",
      "Hier soir, il avait compté vingt fraises bien rouges. Ce matin, il n'en restait aucune. Pas une seule. Juste des feuilles et des trous dans la terre.",
      "« Enquête », écrivit Pistache tout en haut de la page. Puis il souligna deux fois, parce qu'une enquête soulignée deux fois est toujours plus sérieuse.",
      "Il fit d'abord le tour du carré à quatre pattes, très lentement, en tenant son crayon comme une loupe, ce qui ne sert à rien mais donne beaucoup de sérieux à une enquête.",
      "Premier indice : des empreintes dans la terre molle. Toutes petites, avec quatre doigts. Pistache les mesura avec son crayon. « Trop petites pour moi », nota-t-il.",
      "Il alla voir Croquette la hérissonne, qui a exactement quatre doigts. « Ce n'était pas moi, dit-elle. Je n'aime pas les fraises, ça me colle aux piquants. » Et c'était vrai, tout le monde le savait.",
      "Deuxième indice : quelque chose brillait entre deux feuilles. Une plume. Grise, avec le bout blanc. Pistache la rangea dans son carnet et alla voir les pies.",
      "Il nota aussi que les feuilles étaient couchées vers l'ouest, et que trois tiges avaient été cassées à la même hauteur, comme si le voleur n'était pas très grand mais s'y était mis à plusieurs.",
      "Les pies protestèrent très fort, toutes en même temps, ce qui est leur façon de dire bonjour. « On était au clocher toute la nuit ! » Pistache les crut, parce qu'on les entendait effectivement du clocher toute la nuit.",
      "Il s'assit dans l'herbe et relut ses notes. Des empreintes trop petites. Une plume grise. Et, il le remarqua seulement maintenant, une odeur de vase, comme au bord de la mare.",
      "Alors Pistache alla à la mare. Et là, sur la berge, il trouva la vingtième fraise, à moitié mangée, à côté d'une famille de canards très occupés à faire semblant de nager.",
      "Il retourna donc au carré, s'assit exactement là où les tiges étaient cassées et regarda dans la direction où les feuilles étaient couchées. Vers l'ouest. C'est-à-dire, exactement, vers la mare.",
      "« Bonjour », dit Pistache. Les canetons regardèrent ailleurs. La maman cane soupira. « Ils avaient faim. Le maïs de la ferme est fini depuis trois jours. »",
      "Pistache regarda les cinq canetons, puis son carnet, puis les cinq canetons. Il ferma le carnet. « J'ai une meilleure idée qu'une punition », dit-il.",
      "Le plus jeune caneton, celui qui avait encore du duvet sur la tête, s'approcha de Pistache et lui dit tout bas : « Elles étaient très bonnes. » Ce qui, pour une enquête, s'appelle des aveux complets.",
      "Le printemps suivant, il y avait deux carrés dans le jardin de Pistache : un grand pour lui, et un petit tout au bord, exprès pour la mare. Trouver le coupable, c'était la moitié du travail. La bonne moitié, c'était de comprendre pourquoi.",
    ],
    quiz: [
      {
        question: "Combien de fraises Pistache avait-il comptées la veille ?",
        choices: ["Vingt", "Dix", "Cinquante"],
        answer: 0,
        explanation: "Il avait compté vingt fraises bien rouges, et il n'en reste aucune au matin.",
      },
      {
        question: "Pourquoi Croquette la hérissonne n'est-elle pas coupable ?",
        choices: ["Elle n'aime pas les fraises, ça colle à ses piquants", "Elle dormait chez les pies", "Elle est trop grande"],
        answer: 0,
        explanation: "Elle a bien quatre doigts, mais elle déteste les fraises, et tout le monde le sait.",
      },
      {
        question: "Quel indice mène Pistache jusqu'à la mare ?",
        choices: ["Une odeur de vase", "Une plume de pie", "Le bruit du clocher"],
        answer: 0,
        explanation: "En relisant ses notes il remarque une odeur de vase, comme au bord de la mare.",
      },
      {
        question: "Que fait Pistache une fois les coupables trouvés ?",
        choices: ["Il plante un deuxième carré de fraises pour eux", "Il les gronde très fort", "Il construit une barrière"],
        answer: 0,
        explanation: "Il comprend qu'ils avaient faim et plante un petit carré exprès du côté de la mare.",
      },
    ],
    glossary: [
      { word: "enquête", definition: "Une recherche pour découvrir la vérité, en rassemblant des indices un par un." },
      { word: "empreintes", definition: "Les marques laissées par des pattes ou des pieds sur la terre molle." },
      { word: "vase", definition: "La boue molle et grise qui se dépose au fond des mares et des rivières." },
    ],
  },
  "le-robot-qui-apprenait-a-dire-bonjour": {
    body: [
      "Le lundi de la rentrée, il y avait un nouvel élève dans la classe de madame Ferrand. Il mesurait un mètre vingt, il était gris, et il avait deux roues à la place des pieds. Il s'appelait BIP-7.",
      "« BIP-7 vient apprendre avec nous pendant un mois, expliqua la maîtresse. Il sait déjà beaucoup de choses. Il vient apprendre celles qu'on ne trouve pas dans les livres. »",
      "BIP-7 leva un bras et dit, très fort : « BONJOUR. JE SUIS RAVI DE FAIRE VOTRE CONNAISSANCE. » Toute la classe sursauta. Un garçon fit tomber sa trousse.",
      "BIP-7 rangea son cartable dans le casier numéro douze, qu'il mesura d'abord pour vérifier que son cartable rentrait, puis il s'installa au fond de la classe, à la place où il gênait le moins de monde.",
      "« C'est trop fort », dit Lina, du deuxième rang. BIP-7 nota quelque chose dans son programme. Le lendemain, il dit exactement la même phrase, mais tellement bas que personne ne l'entendit.",
      "« C'est trop bas », dit Lina. BIP-7 nota encore. Le troisième jour, il trouva le bon volume, mais il dit sa phrase à la fenêtre, parce que la fenêtre était le premier objet de la pièce dans son ordre de balayage.",
      "Ça continua comme ça toute la semaine. BIP-7 disait toujours la même phrase, complète, parfaitement prononcée : « BONJOUR. JE SUIS RAVI DE FAIRE VOTRE CONNAISSANCE. » Et chaque fois, quelque chose n'allait pas.",
      "Le jeudi, il essaya de dire bonjour en marchant, ce qui donna une phrase coupée en deux par le bruit de ses roues. Le vendredi matin, il la dit à l'envers, en commençant par la fin, ce qui n'arrangea rien du tout.",
      "Le vendredi, il roula jusqu'au bureau de la maîtresse. « Je ne comprends pas. Ma phrase est correcte. Mon volume est correct. Pourquoi est-ce que ça ne marche pas ? »",
      "Madame Ferrand réfléchit. Puis elle appela Lina. « Lina, tu dis bonjour comment, toi ? » Lina haussa les épaules. « Ben... ça dépend. »",
      "« Ça dépend de quoi ? » demanda BIP-7, et pour la première fois toutes ses lumières se mirent à clignoter en même temps. « De qui c'est, dit Lina. De si on l'a vu hier. De s'il a l'air content ou pas. »",
      "« Mais alors il n'y a pas de règle ? » demanda BIP-7, et sa voix monta un peu, ce qui ne lui était jamais arrivé. « Il y en a une, dit madame Ferrand. Regarder la personne avant de parler. Le reste vient tout seul. »",
      "BIP-7 resta immobile pendant onze secondes, ce qui est très long pour un robot. Puis il effaça sa phrase. Toute la phrase. Quatre cents langues et une seule formule, effacées d'un coup.",
      "Le lundi suivant, il entra, s'arrêta près du deuxième rang et dit simplement : « Salut Lina. » Puis il roula vers le garçon à la trousse et dit : « Ça va mieux, ta trousse ? »",
      "Il commença par les plus faciles : ceux qu'il avait vus la veille, ceux qui souriaient déjà. Il garda pour la fin ceux qui regardaient par terre, parce qu'il avait calculé qu'avec eux, il fallait s'appliquer davantage.",
      "La classe éclata de rire, et BIP-7 enregistra le son du rire dans un fichier qu'il appela « réussi ». Il avait mis une semaine à comprendre que dire bonjour, ce n'est pas prononcer un mot : c'est montrer qu'on a remarqué quelqu'un.",
    ],
    quiz: [
      {
        question: "Que vient faire BIP-7 dans la classe ?",
        choices: ["Apprendre ce qui n'est pas dans les livres", "Aider la maîtresse à corriger", "Réparer les ordinateurs"],
        answer: 0,
        explanation: "Il sait déjà beaucoup de choses : il vient apprendre celles qu'on ne trouve pas dans les livres.",
      },
      {
        question: "Quel est le problème le troisième jour ?",
        choices: ["Il dit bonjour à la fenêtre", "Il parle trop fort", "Il oublie sa phrase"],
        answer: 0,
        explanation: "Le volume est bon, mais il s'adresse à la fenêtre, premier objet de son ordre de balayage.",
      },
      {
        question: "Que répond Lina quand on lui demande comment elle dit bonjour ?",
        choices: ["« Ça dépend »", "« Très fort »", "« Toujours pareil »"],
        answer: 0,
        explanation: "Ça dépend de qui c'est, de si on l'a vu hier, de s'il a l'air content ou pas.",
      },
      {
        question: "Que fait BIP-7 après avoir compris ?",
        choices: ["Il efface sa phrase toute faite", "Il apprend une nouvelle langue", "Il baisse son volume"],
        answer: 0,
        explanation: "Il efface complètement sa formule, et se met à parler à chacun différemment.",
      },
    ],
    glossary: [
      { word: "programme", definition: "La liste d'instructions qu'un robot ou un ordinateur suit pour savoir quoi faire." },
      { word: "volume", definition: "La force d'un son : plus le volume est grand, plus on entend fort." },
      { word: "fichier", definition: "Une boîte dans la mémoire d'une machine, où l'on range une information pour la retrouver." },
    ],
  },
  "une-journee-avec-la-boulangere": {
    body: [
      ...
      "Son père la déposa devant le rideau de fer baissé, dans une rue complètement vide. Il n'y avait aucune lumière nulle part, sauf une seule, tout au fond de la boutique, et c'était celle du fournil.",
      "Dans le fournil, il faisait déjà chaud et ça sentait bon. Tante Marion lui donna un tablier blanc beaucoup trop grand et lui montra une grande bassine remplie d'une pâte grise et molle.",
      "« Voici Gaspard, dit tante Marion sérieusement. C'est mon levain. Il a vingt-six ans. Je le nourris tous les jours, comme un animal. Si Gaspard meurt, mon pain n'a plus de goût. »",
      "Zoé regarda la bassine avec beaucoup plus de respect. Puis elle apprit à pétrir. Ça a l'air facile de loin. De près, c'est du sport : il faut pousser, replier, tourner, et recommencer cent fois.",
    ...
    quiz: [
      {
        question: "À quelle heure commence la journée de tante Marion ?",
        choices: ["Quatre heures du matin", "Six heures du matin", "Midi"],
        answer: 0,
        explanation: "Le réveil sonne à quatre heures moins dix, dans le noir complet.",
      },
      {
        question: "Qui est Gaspard ?",
        choices: ["Le levain de la boulangerie, âgé de vingt-six ans", "Le chien de tante Marion", "Le premier client du matin"],
        answer: 0,
        explanation: "C'est le levain, nourri tous les jours comme un animal depuis vingt-six ans.",
      },
      {
        question: "Que fait le premier client avec sa baguette ?",
        choices: ["Il en casse le bout et le mange sur le trottoir", "Il la coupe en deux pour la partager", "Il la range dans son sac"],
        answer: 0,
        explanation: "Il casse le bout dehors et le mange sur place, les yeux fermés.",
      },
      {
        question: "Pourquoi tante Marion se lève-t-elle à quatre heures ?",
        choices: ["Pour ce moment sur le trottoir", "Parce que le four est lent", "Pour finir plus tôt le soir"],
        answer: 0,
        explanation: "Elle le dit elle-même : pas pour le pain, pour ce bout de trottoir.",
      },
    ],
    glossary: [
      { word: "fournil", definition: "La pièce de la boulangerie où l'on prépare la pâte et où se trouve le four." },
      { word: "levain", definition: "Une pâte vivante qu'on garde et qu'on nourrit, et qui fait gonfler le pain." },
      { word: "pétrir", definition: "Travailler la pâte avec les mains en la poussant et la repliant, encore et encore." },
    ],
  },
  "le-dragon-pompier": {
    body: [
      ...
      "Au centre de secours, le capitaine Roussel avait été très poli. « C'est une belle idée. Mais tu comprends, un dragon dans une caserne de pompiers, c'est comme un renard dans un poulailler. »",
      "Braise avait compris. Il était rentré chez lui. Puis il était revenu le lendemain, et le jour d'après, et pendant deux mois, tous les matins, s'asseoir devant la caserne sans rien demander.",
      "Un soir d'août, la sirène partit. Un feu dans les collines, du côté des vignes, avec du vent. Le mauvais genre de feu : celui qui court plus vite que les camions.",
      ...
      "Les pompiers travaillèrent toute la nuit et n'arrivèrent pas à en faire le tour. Au matin, le capitaine Roussel, noir de suie, se retourna et vit Braise, assis à sa place habituelle.",
      ...
      "Aujourd'hui, il y a un casque rouge de la taille d'une baignoire accroché dans la caserne de Fontclaire. Personne d'autre ne peut le porter, et personne n'a jamais proposé de l'enlever.",
      "Il y eut ensuite trois jours de fumée, de branches noires et de gens qui venaient dire merci sans trop savoir à qui. Braise dormit quarante heures d'affilée dans la cour de la caserne, et personne ne le réveilla.",
    ...
    quiz: [
      {
        question: "Quel métier Braise veut-il faire ?",
        choices: ["Pompier", "Cuisinier", "Garde du château"],
        answer: 0,
        explanation: "Il l'a décidé à six ans, en regardant passer le camion rouge du village.",
      },
      {
        question: "Que fait Braise après le refus du capitaine ?",
        choices: ["Il revient s'asseoir devant la caserne tous les matins", "Il part vivre dans les collines", "Il apprend un autre métier"],
        answer: 0,
        explanation: "Pendant deux mois, il revient chaque matin s'asseoir devant la caserne sans rien demander.",
      },
      {
        question: "Comment Braise éteint-il l'incendie ?",
        choices: ["Il aspire l'eau du lac et la souffle sur les flammes", "Il souffle du feu plus fort que l'incendie", "Il creuse un fossé avec sa queue"],
        answer: 0,
        explanation: "Il plonge la tête dans le lac, aspire, remonte et souffle l'eau au-dessus des flammes.",
      },
      {
        question: "Combien d'allers-retours jusqu'au lac faut-il ?",
        choices: ["Onze", "Trois", "Vingt"],
        answer: 0,
        explanation: "Il faut onze allers-retours, et à la fin Braise ne tient plus debout.",
      },
    ],
    glossary: [
      { word: "caserne", definition: "Le bâtiment où vivent et travaillent les pompiers, avec leurs camions." },
      { word: "suie", definition: "La poussière noire que laisse la fumée sur tout ce qu'elle touche." },
      { word: "sirène", definition: "L'appareil qui hurle très fort pour prévenir les pompiers qu'ils doivent partir." },
    ],
  },
};
...
const STORY_CONTENT_EN: Record<string, StoryContent> = {
  ...
  "la-licorne-qui-avait-perdu-ses-couleurs": {
    body: [
      "Iris the unicorn woke up one morning and knew at once that something was wrong. Her mane, usually pink and blue and gold, had turned white. Completely white, like a cloud that had forgotten the sky.",
      "“My colours!” cried Iris. She galloped to the pond to look at herself. It was quite true: not a single colour anywhere. Even her horn, which normally shone like a summer morning, was grey and dull.",
      "Iris sat down in the meadow and hung her head very low. A unicorn with no colours cannot possibly exist, she thought. So she went and hid behind the big wild rose bush at the far end of the field, where nobody would see her like this.",
      "But her friends were already looking for her. The first to arrive came scampering along: it was Pablo the squirrel. “There you are! I saved the finest hazelnut of the autumn just for you.” He laid it down in front of her and noticed nothing at all.",
      "Then came Nina the blue tit, who perched on her ear and sang the song Iris liked best, the one with three little whistles at the end. Then Big-Hoof the pony, who said not one word and simply rested his head against hers, because sometimes that is exactly the right thing to do.",
      "Iris slowly lifted her eyes. On her mane, where Pablo had set down his hazelnut, there was a golden streak. Where Nina had sung, a blue one. And where Big-Hoof had rested his head, a great pink one.",
      "“You gave me my colours back!” whispered Iris. “No,” said Nina, tilting her little head. “They were there all along. They were only waiting for someone to come and look at you.”",
      "Ever since that day, when Iris feels a little grey, she does not go and hide behind the bush any more. She goes to find her friends. Colours are never really lost: they come back the moment someone takes the time to look at you.",
    ],
    quiz: [
      {
        question: "What does Iris discover when she wakes up?",
        choices: ["Her mane has turned white", "Her horn has vanished", "She has grown taller"],
        answer: 0,
        explanation: "Her pink, blue and gold mane has turned white like a cloud.",
      },
      {
        question: "Who arrives first to see Iris?",
        choices: ["Nina the blue tit", "Pablo the squirrel", "Big-Hoof the pony"],
        answer: 1,
        explanation: "Pablo the squirrel arrives first, with the finest hazelnut of the autumn.",
      },
      {
        question: "How do Iris's colours come back?",
        choices: ["When her friends come to see her", "When she washes in the pond", "When the sun rises"],
        answer: 0,
        explanation: "Each friend gives her back a streak of colour, simply by coming to see her.",
      },
    ],
    glossary: [
      { word: "mane", definition: "The long hair that grows along the neck of horses and unicorns." },
      { word: "horn", definition: "The magic point that grows on a unicorn's forehead." },
      { word: "meadow", definition: "A big field of green grass, full of flowers in springtime." },
    ],
  },
  "le-loup-qui-voulait-juste-un-ami": {
    body: [
      "Everyone in the forest knew Gris the wolf. Or rather, everyone knew his pointed ears, his big shadow and the sound of his paws on the leaves. Nobody really knew Gris.",
      "In the evening, in his clearing, Gris practised. He stood in front of a tree trunk and said, very politely: “Hello, my name is Gris. Would you like to play?” The trunk never answered, but at least it did not run away.",
      "The next day, Gris tried for real. He saw a rabbit, he opened his mouth, and the rabbit was already gone. He saw three blue tits, he took one step, and the three blue tits became three dots in the sky.",
      "“It must be my voice,” thought Gris. So he spoke very softly. That did not work. “It must be my size,” he thought next. So he lay down flat in the grass to be as small as possible. That did not work either.",
      "One rainy evening, Gris heard a tiny sniffle under a fern. It was Pruneau, a soaking wet hedgehog, lost and not at all pleased about it. “Hello,” said Gris without thinking. “Would you like to shelter under my tummy? It is warm.”",
      "Pruneau looked up. He looked at the big teeth, the pointed ears, the enormous shadow. Then he looked at the eyes, which were worried and kind. And since it really was raining very hard, he said: “All right.”",
      "They stayed there all night, hardly saying a word, listening to the rain falling on the ferns. In the morning, Pruneau yawned and asked: “What are you doing tomorrow?”",
      "Gris did not answer straight away, because his throat felt rather tight. He had searched the whole forest for a friend, practising every single evening. All it took in the end was forgetting to practise, and offering his warm tummy to somebody who was cold.",
    ],
    quiz: [
      {
        question: "What does Gris practise saying hello to?",
        choices: ["A tree trunk", "A mirror", "His mother"],
        answer: 0,
        explanation: "He practises in front of a tree trunk, which never answers but never runs away.",
      },
      {
        question: "Who does Gris find under the fern?",
        choices: ["A rabbit", "Pruneau the hedgehog", "A blue tit"],
        answer: 1,
        explanation: "He finds Pruneau, a soaking wet hedgehog lost in the rain.",
      },
      {
        question: "Why does Pruneau agree to stay?",
        choices: ["Because it is raining hard and Gris's tummy is warm", "Because he is too scared to leave", "Because he wants something to eat"],
        answer: 0,
        explanation: "He sees Gris's kind eyes, and since it is raining very hard, he says yes.",
      },
    ],
    glossary: [
      { word: "clearing", definition: "A space with no trees in the middle of a forest, where you can see the sky." },
      { word: "fern", definition: "A tall green plant with feathery leaves that grows in the shade." },
      { word: "hedgehog", definition: "A small animal covered in spines, who rolls into a ball when frightened." },
    ],
  },
  "nino-part-a-l-ecole-des-petits": {
    body: [
      "This morning there is a brand new satchel on Nino's chair. It is blue, it smells of plastic, and it is almost as big as Nino. Inside there is nothing at all. Well, almost nothing.",
      "Because Nino has slipped his cuddly toy right down to the bottom, under the snack. “Nobody must see him,” he whispers. “But he has to be there.” Mum nods, and she does not tell a soul.",
      "Outside the school there is a lot of noise, a lot of parents and a lot of little ones holding one hand very tightly. Nino is holding Mum's hand very tightly too. Perhaps even a bit too tightly.",
      "The teacher is called Salomé. She crouches down to Nino's height and says: “Hello Nino. Would you like to come in with me, or would you rather have one more minute?” Nino thinks about it. “One more minute.” “All right,” says Salomé.",
      "One minute is short. But it is already better than right now. When it is over, Nino lets go of Mum's hand, very slowly, one finger at a time.",
      "Inside there are tiny tables, a round rug, and a box full of cars. There is also a little girl crying, and Nino lends her a red car without saying anything, because he knows exactly how she feels.",
      "In the afternoon, out in the playground under the shelter, Nino opens his satchel to check. The cuddly toy is there, between the snack and the box of tissues, exactly where he put him.",
      "In the evening Mum asks: “Did you take your cuddly toy out?” Nino thinks, and shakes his head. He did not need to. But knowing he was there, right at the bottom, helped him all day long.",
    ],
    quiz: [
      {
        question: "What does Nino hide at the bottom of his satchel?",
        choices: ["His cuddly toy", "A red car", "His snack"],
        answer: 0,
        explanation: "He slips his cuddly toy right to the bottom, under the snack, so nobody sees him.",
      },
      {
        question: "What does the teacher Salomé offer Nino?",
        choices: ["To come in with her, or wait one more minute", "To go back home", "To tidy his satchel"],
        answer: 0,
        explanation: "She crouches down and gives him the choice: come in with her, or one more minute.",
      },
      {
        question: "What does Nino do when a little girl cries?",
        choices: ["He lends her a red car", "He calls the teacher", "He cries too"],
        answer: 0,
        explanation: "He lends her a red car without a word, because he knows how she feels.",
      },
    ],
    glossary: [
      { word: "satchel", definition: "The bag you carry on your back to take your things to school." },
      { word: "teacher", definition: "The grown-up who looks after the children and teaches them things at school." },
      { word: "playground", definition: "The outdoor space at school where children play at break time." },
    ],
  },
  "le-gouter-surprise-de-pilou": {
    body: [
      "This morning Pilou woke up with a very important idea in his head: today he is three years old. He repeated it quietly three times just to be sure. Three years old.",
      "He came running out of his room. Mummy Rabbit was reading. “Morning, Pilou,” she said, and added nothing at all. No “happy birthday”. Nothing.",
      "At lunchtime there were carrots, the same as every day. In the afternoon Daddy Rabbit went out shopping and said: “Whatever you do, don't go into the big burrow at the back.” Pilou nodded, and thought that was rather odd.",
      "So Pilou went and sat by himself in front of the door. He counted the clouds. He counted eleven of them. “They forgot,” he said quietly to a pebble, because there was nobody else to say it to.",
      "The pebble did not answer, but the wind carried a curious smell. A smell of hazelnut cake. A smell coming, as it happens, from the big burrow at the back.",
      "Pilou crept closer on tiptoe paws. The door flew open and twenty voices shouted all at once: “SURPRISE!” There was a garland, a cake, his cousins, his neighbours and even the old mole from next door.",
      "“We pretended all day long,” said Mummy Rabbit. “It was very, very hard.” “I nearly told you at breakfast,” admitted Daddy Rabbit.",
      "Pilou blew out his three candles in one go. He had thought everyone forgot him, when really they had been thinking about him since morning, in secret. That is what a surprise is: love hiding for a little while.",
    ],
    quiz: [
      {
        question: "How old is Pilou today?",
        choices: ["Three years old", "Two years old", "Five years old"],
        answer: 0,
        explanation: "Pilou wakes up with a very important idea: today he is three years old.",
      },
      {
        question: "Where does Daddy Rabbit forbid him to go?",
        choices: ["The big burrow at the back", "The garden", "The mole's house"],
        answer: 0,
        explanation: "He forbids the big burrow at the back, which is exactly where the surprise is.",
      },
      {
        question: "What puts Pilou on the trail?",
        choices: ["A smell of hazelnut cake", "A noise in the kitchen", "A letter on the door"],
        answer: 0,
        explanation: "The wind carries a smell of hazelnut cake from the burrow at the back.",
      },
    ],
    glossary: [
      { word: "burrow", definition: "The home dug under the ground where rabbits and foxes live." },
      { word: "garland", definition: "A long decoration of paper or flowers, hung up for a celebration." },
      { word: "mole", definition: "A small black animal that lives under the ground and sees very poorly." },
    ],
  },
  "le-sapin-qui-n-aimait-pas-les-boules": {
    body: [
      "Beside the path there was a little fir tree with a problem. Every year in December, the villagers came to dress him in shiny baubles. And every year, within two hours, every bauble was on the ground.",
      "The fir tree made them fall. Not unkindly. He simply shook his needles a little, the way you do with a scratchy scarf, and plop, the baubles slid into the snow.",
      "“What a fussy tree,” the villagers said as they walked away. The fir tree could not answer, of course. But if he could have, he would have said: “It tickles.”",
      "One evening a tiny fairy called Brume landed on his topmost branch. She was very small, she was cold, and she was looking for somewhere to sleep. “Why aren't you decorated?” she asked.",
      "The fir tree gently shook his needles. One last forgotten bauble dropped into the snow, plop. Brume understood at once. “Ah,” she said. “You don't like things that hang on you.”",
      "So Brume did something nobody had tried. She put nothing on the tree at all. She breathed, very softly, and frost drew stars on every single needle. Then she called her friends, and the fireflies came to settle wherever they pleased, tied to nothing.",
      "In the morning the whole village stopped in front of the little fir tree. He shone brighter than all the others, with his stars of frost and his living lights that shifted a little whenever the wind went by.",
      "“How did he do that?” asked a child. Nobody could answer. But the fir tree knew: they had not decorated him like the others, they had decorated him like himself.",
    ],
    quiz: [
      {
        question: "What does the little fir tree do with the baubles?",
        choices: ["He shakes his needles and makes them fall", "He breaks them", "He hides them in the snow"],
        answer: 0,
        explanation: "He shakes his needles a little and the baubles slide down into the snow.",
      },
      {
        question: "Why does the fir tree drop the baubles?",
        choices: ["They tickle him", "He does not like Christmas", "They are too heavy"],
        answer: 0,
        explanation: "He is not fussy: the baubles tickle, like a scratchy scarf.",
      },
      {
        question: "How does Brume decorate the tree?",
        choices: ["With frost and fireflies", "With smaller baubles", "With ribbons"],
        answer: 0,
        explanation: "She breathes stars of frost onto the needles and calls the fireflies, who settle freely.",
      },
    ],
    glossary: [
      { word: "needles", definition: "The small pointed green leaves of a fir tree, thin as little spines." },
      { word: "frost", definition: "The thin white ice that settles on plants on very cold mornings." },
      { word: "fireflies", definition: "Little insects that glow in the dark, like tiny flying lamps." },
    ],
  },
  "le-dinosaure-qui-avait-peur-du-tonnerre": {
    body: [
      "Barnabé was a very big dinosaur. When he walked, the puddles rippled and the little pebbles jumped. He was afraid of nothing at all. Except one single thing.",
      "Thunder. The moment the sky went BOOM, Barnabé hid behind the biggest rock he could find. Which was tricky, because he was bigger than most rocks.",
      "That evening the storm arrived just before bedtime. First the wind. Then a great white light in the sky. Then, a few seconds later: BOOM.",
      "Barnabé rushed off to hide behind the nearest rock, but his tail stuck out on one side, his feet stuck out underneath, and his big nose stuck out on the other side. Mummy Dinosaur came and sat down beside him, quite calmly, as though nothing at all were happening.",
      "“Do you know what thunder is?” she asked. “It's a monster,” said Barnabé, eyes shut tight. “No. It is only the sound the lightning makes. Light travels very fast, sound travels slower. The sound is running along behind, that is all.”",
      "She taught him a game. “When you see the lightning, you count. One, two, three. When you hear the BOOM, you stop. The bigger the number, the further away the storm is.”",
      "So they counted together. The first time: one, two. The second time: one, two, three, four. Then one, two, three, four, five, six, seven.",
      "“It's leaving!” cried Barnabé, delighted to have won. He fell asleep before the tenth flash. The thunder had not changed one bit: it was Barnabé who now had something to do while it rumbled.",
    ],
    quiz: [
      {
        question: "What is Barnabé afraid of?",
        choices: ["Thunder", "The dark", "Water"],
        answer: 0,
        explanation: "Barnabé fears nothing at all, except the thunder that goes BOOM.",
      },
      {
        question: "What is thunder, according to Mummy Dinosaur?",
        choices: ["The sound the lightning makes", "A monster in the clouds", "The falling rain"],
        answer: 0,
        explanation: "Light travels fast, sound travels slower: thunder runs along behind the lightning.",
      },
      {
        question: "What is the counting game for?",
        choices: ["To tell whether the storm is moving away", "To make the rain come", "To fall asleep faster"],
        answer: 0,
        explanation: "The bigger the number between the flash and the BOOM, the further off the storm.",
      },
    ],
    glossary: [
      { word: "thunder", definition: "The big rumbling noise that rolls across the sky during a storm." },
      { word: "lightning", definition: "The great white light that zigzags across the sky before the thunder." },
      { word: "storm", definition: "A time when the sky turns dark, with wind, rain and thunder." },
    ],
  },
  "le-chien-qui-gardait-les-chaussons": {
    body: [
      "In the Berger house there were four people and one dog. The four people were called Dad, Mum, Louise and Tom. The dog was called Biscotte, and Biscotte had one very serious passion: slippers.",
      "Every night, while everyone slept, Biscotte did her rounds. She fetched Dad's blue slipper. Then Mum's two pink ones. Then Louise's, then Tom's, then Tom's other one, which was always further away than the first.",
      "She carried them back one by one to her basket, arranged them in a neat round heap, and lay down on top. There. That was her night's work.",
      "In the morning it was always the same song. “Where are my slippers?” Dad shouted from the stairs. “Under the dog!” the other three answered all at once.",
      "So everyone came into the kitchen, and negotiations began. Biscotte did not growl, did not bite, and did not move either. She simply pretended to be very deeply asleep, which is the finest defence known to dogs.",
      "One day Louise decided to investigate. She asked the vet why Biscotte stole the slippers. The vet thought about it and said: “She is not stealing them. She is gathering them.”",
      "“A slipper keeps the smell of the person who wears it,” she explained. “Biscotte cannot fit all four of you into her basket. So she takes the thing that is most like you, and sleeps in the middle of it.”",
      "That evening Louise deliberately put her slipper right beside the basket, to make the job easier. The whole family did the same, without saying a word to each other. The next morning nobody could find their slippers, and for the first time it made everybody laugh.",
    ],
    quiz: [
      {
        question: "What does Biscotte do at night?",
        choices: ["She gathers all the slippers into her basket", "She guards the door", "She eats the slippers"],
        answer: 0,
        explanation: "She does her rounds and carries every slipper back into a neat round heap in her basket.",
      },
      {
        question: "How does Biscotte defend herself in the morning?",
        choices: ["She pretends to be very deeply asleep", "She growls", "She runs off into the garden"],
        answer: 0,
        explanation: "She does not growl or move: she pretends to be asleep, the finest defence known to dogs.",
      },
      {
        question: "Why does Biscotte gather the slippers?",
        choices: ["They keep the smell of her family", "They are nice to chew", "She wants to hide them"],
        answer: 0,
        explanation: "She cannot fit four people in her basket, so she takes the thing most like them.",
      },
    ],
    glossary: [
      { word: "slipper", definition: "The soft shoe you wear indoors to keep your feet warm." },
      { word: "basket", definition: "The bed a dog or cat sleeps in, usually with a cushion inside." },
      { word: "vet", definition: "The animal doctor, who treats them and understands how they live." },
    ],
  },
  "la-sirene-et-le-coquillage-qui-chante": {
    body: [
      "Among the mermaids of the blue reef, there was a song for everything. To call the dolphins, to send the babies to sleep, to greet the whales passing far out. Singing was like breathing.",
      "Nérine, the youngest, had a problem. When she opened her mouth, a sound came out. One sound. A small flat sound, perfectly straight, like a creaking door. Her three sisters, meanwhile, made the water tremble with happiness.",
      "“It will come,” her mother said every evening. But the great tide concert was approaching, and Nérine knew perfectly well that it would not come.",
      "In the evenings, hidden behind a rock, Nérine listened to her sisters rehearse. They climbed so high that the lantern fish lit up all by themselves. Nérine tried quietly in her corner, and the small flat sound came out all the same.",
      "So she spent her days far from the reef, digging through the sand. And there, one morning, under an old rusted anchor, she found the shell. It was pearly, twisted, and not especially pretty.",
      "Nérine blew into it, the way you blow out a candle. And the shell began to sing. Not a whistle: a real voice, round and warm, rising and falling like the swell.",
      "On the evening of the concert, Nérine hid the shell behind her back. When her turn came, she blew. The voice rose above the reef, and everyone fell silent. Even the old turtles stopped chewing.",
      "The whole reef was holding its breath. The seahorses had stopped circling the weed. Right at the bottom, two crabs who had been arguing since morning broke off in the middle of a raised claw.",
      "“Nérine!” cried her mother, eyes shining. Her sisters stared at her, understanding nothing. And Nérine, in the middle of the applause, felt herself turn very cold.",
      "She waited for the silence to come back. Then she brought her hands round in front of her and showed the shell to everyone. “It isn't me,” she said in her small flat voice. “It's him. I found him under the anchor.”",
      "There was a long moment of nothing at all. Then the oldest mermaid of the reef came forward, took the shell, turned it in the light and asked: “You found this by yourself? Under the sand?”",
      "The old mermaid held the shell to her ear, then to the light, then to her ear again. She was two hundred years old and had never seen anything like it in the whole ocean.",
      "“Yes,” said Nérine. “There are a hundred of us on this reef,” said the old mermaid. “A hundred of us swimming past that anchor for fifty years. Not one of us ever found a single thing.”",
      "Since that day, Nérine has a job all of her own. She searches. She has brought back a silver comb, a ship's bell, a stone that glows in the dark and two more shells that sing.",
      "They built her a little workshop in a hollow of the reef, with shelves of packed sand. Every object lies on a bed of seaweed, with a small scale label saying exactly where it was found.",
      "She still does not sing very well. But when the tide concert begins, she is the one who brings the voices. A talent is not always the family one: sometimes it waits, all alone, under an old anchor.",
    ],
    quiz: [
      {
        question: "What is Nérine's problem?",
        choices: ["Her voice makes only one small flat sound", "She is afraid of deep water", "She does not know the songs"],
        answer: 0,
        explanation: "When she opens her mouth, one flat sound comes out, like a creaking door.",
      },
      {
        question: "Where does Nérine find the shell?",
        choices: ["Under an old rusted anchor", "In a turtle's nest", "At the back of a cave"],
        answer: 0,
        explanation: "She finds it one morning in the sand, under an old rusted anchor.",
      },
      {
        question: "What does Nérine do after the applause?",
        choices: ["She shows the shell and tells the truth", "She swims away from the concert", "She starts singing again"],
        answer: 0,
        explanation: "She brings her hands forward and explains that the voice comes from the shell.",
      },
      {
        question: "What is Nérine's real talent?",
        choices: ["Finding what nobody else can see", "Swimming faster than her sisters", "Talking to whales"],
        answer: 0,
        explanation: "A hundred mermaids swam past that anchor for fifty years and saw nothing.",
      },
    ],
    glossary: [
      { word: "reef", definition: "A long barrier of rock and coral, just below the surface of the sea." },
      { word: "swell", definition: "The slow steady movement of the sea, rising and falling without breaking." },
      { word: "anchor", definition: "The heavy metal weight dropped to the seabed to stop a boat drifting away." },
    ],
  },
  "le-pirate-qui-avait-le-mal-de-mer": {
    body: [
      "Captain Soft-Beard had everything a great pirate needs. The hat. The parrot. The voice that makes seagulls tremble. He knew all one hundred and thirty-two sailor's knots by heart and could read the stars with his eyes almost shut.",
      "He just had one tiny flaw, which nobody on board ever mentioned: Captain Soft-Beard got seasick.",
      "The moment the ship moved a little, his face went from pink to white, then from white to pale green, like an unripe apple. So he clung to the rail and stared very hard at the horizon, thinking about something else.",
      "He had tried everything. Ginger. Dry biscuits. A bracelet bought at great expense from a merchant in Tangier who had promised miracles. The bracelet had ended up at the bottom of the sea, thrown overboard one stormy day, along with a great many words the parrot still repeats.",
      "The crew pretended not to notice. “The captain is thinking,” the first mate would say, pushing the others towards the bow. “Don't disturb him, he is thinking very, very hard.”",
      "One day of heavy swell, the captain was thinking so hard that he could not let go of the rail at all. And that was exactly the day the lookout shouted: “Reef dead ahead!”",
      "They had to turn at once. The first mate ran to the wheel, but he did not know which way. Nobody knew. Everyone began shouting at the same time, which has never turned a single ship.",
      "The parrot, incidentally, was called Peanut and was no help at all. Every time the captain turned green, Peanut came down to perch on his shoulder and shouted, very pleased with himself: “Land! Land!” when there was no land whatsoever.",
      "“STARBOARD!” roared the captain without turning round, still bent double. “Then hard to port, count to six, and straighten up!”",
      "The first mate obeyed. The ship heeled over, skimmed the reef by a hair, and sailed off straight into the wind. When calm returned, the crew turned towards the captain, who still had not moved.",
      "“How did you know?” asked the first mate. “Because I watch the horizon all day long,” answered Soft-Beard. “For three hours I had been looking at exactly that spot. I saw it before anyone else.”",
      "The first mate could hardly believe it. In three years of sailing with him, he had always assumed the captain gripped the rail out of habit, the way other people bite their nails.",
      "That evening the crew slung a hammock in the middle of the ship, at the precise point where it moves the least. Then they hung the compass right above it, at eye height.",
      "“You are our lookout, captain,” said the first mate. “The best in all the oceans. You never take your eyes off the horizon.”",
      "The hammock was slung with double bowlines, the knots that never give. Peanut was given strict orders never to shout “Land” again without land. He obeyed for almost two whole days.",
      "Soft-Beard opened his mouth to protest, then shut it again. It was true that he never took his eyes off the horizon. He had spent twenty years hiding his flaw, and had just discovered that he had turned it, without knowing, into his finest talent.",
    ],
    quiz: [
      {
        question: "What is Captain Soft-Beard's flaw?",
        choices: ["He gets seasick", "He cannot swim", "He is afraid of the dark"],
        answer: 0,
        explanation: "As soon as the ship moves he turns pale green, like an unripe apple.",
      },
      {
        question: "What does the crew say to protect him?",
        choices: ["That the captain is thinking very hard", "That the captain is asleep", "That the captain is counting seagulls"],
        answer: 0,
        explanation: "The first mate keeps repeating that the captain is thinking and must not be disturbed.",
      },
      {
        question: "How does the captain save the ship from the reef?",
        choices: ["He shouts the orders without turning round", "He takes the wheel himself", "He drops the anchor"],
        answer: 0,
        explanation: "Still bent double, he shouts starboard, then hard to port, count to six.",
      },
      {
        question: "Why had he seen the reef before everyone else?",
        choices: ["He watches the horizon all day long", "He has a magic telescope", "The parrot warned him"],
        answer: 0,
        explanation: "His seasickness makes him stare at the horizon, so he sees everything coming first.",
      },
    ],
    glossary: [
      { word: "rail", definition: "The barrier running around the deck of a ship, which you hold on to." },
      { word: "lookout", definition: "The person whose job is to watch the sea and warn the crew of what they see." },
      { word: "compass", definition: "The small instrument whose needle always points north." },
    ],
  },
  "la-licorne-des-lanternes-de-noel": {
    body: [
      "Every twenty-fourth of December, the village of Fontclaire held the lantern vigil. Everyone came out into the night with a paper lantern, and they walked together up to the old chapel at the top of the path.",
      "It made a long line of little lights climbing through the dark. From far away it looked like a necklace laid across the hill.",
      "But that year, barely a minute after setting off, a gust of wind swept down the street. Pfff. Every lantern went out at the same instant, from one end of the village to the other.",
      "The lanterns were made all through the day of the twenty-fourth. The children glued the paper, the grown-ups fitted the wooden sticks, and the baker lent his flour paste, which smells of warm bread and holds better than anything.",
      "There was a great silence, then a few nervous laughs, then nothing at all. Without the lanterns the path turned black as ink, and nobody felt like climbing it.",
      "“Let's go home,” said someone. “Much safer,” said another. People were already turning back when little Adèle raised one finger towards the top of the hill.",
      "“Look. There's one left.” Right at the top, tiny, a light was still shining. It did not tremble, it did not flicker. It was waiting.",
      "The wind, meanwhile, had gone as fast as it came. That was the most annoying part: there was not a breath of air left, not one reason to go home, and yet nobody moved.",
      "Adèle set off first, her unlit lantern in her hand. Nobody held her back, because everyone was far too busy staring. Then her father followed, then the baker, then all the others.",
      "Arriving at the top, out of breath, they saw that the light was not a lantern at all. It was a horn. One long white horn, on the forehead of a unicorn sitting in the snow, as calm as if she had been waiting forever.",
      "Adèle stepped forward and held out her lantern. The unicorn tilted her head and touched the wick with the tip of her horn. The little flame sprang back at once, yellower and rounder than before.",
      "Nobody said anything for a long while. All you could hear was the snow creaking under boots and the breath of the unicorn, making small white clouds in front of her nostrils.",
      "So each of them came forward in turn, one after another. A hundred lanterns were relit one by one from a single horn, and the unicorn never moved from her place.",
      "Then she stood, shook the snow from her back and walked down towards the forest without looking round. The light of her horn became a dot, and then nothing.",
      "It took some time, because there were many of them and they went up one at a time, without pushing. The smallest ones went first. Not one person thought to object.",
      "People still tell the story of the vigil when every lantern went out. They often forget the ending: it was not the unicorn who saved the evening, it was Adèle, who raised one finger and climbed first into the dark.",
    ],
    quiz: [
      {
        question: "What happens at the start of the vigil?",
        choices: ["A gust of wind blows out every lantern", "It starts snowing heavily", "The chapel is locked"],
        answer: 0,
        explanation: "A gust sweeps down the street and puts out every lantern at the same instant.",
      },
      {
        question: "Who notices the light still shining?",
        choices: ["Little Adèle", "The baker", "Adèle's father"],
        answer: 0,
        explanation: "Adèle raises a finger towards the top of the hill and shows everyone the light.",
      },
      {
        question: "What is that light, really?",
        choices: ["A unicorn's horn", "A forgotten lantern", "A very low star"],
        answer: 0,
        explanation: "It is a long white horn on the forehead of a unicorn sitting in the snow.",
      },
      {
        question: "Who really saved the vigil?",
        choices: ["Adèle, by climbing first into the dark", "The unicorn, by relighting the lanterns", "The wind, by dropping"],
        answer: 0,
        explanation: "Without Adèle raising her finger and setting off first, the whole village would have gone home.",
      },
    ],
    glossary: [
      { word: "vigil", definition: "An evening spent together late at night, to celebrate or to tell stories." },
      { word: "chapel", definition: "A very small church, often standing a little away from the village." },
      { word: "wick", definition: "The small thread in the middle of a candle, the part that catches fire." },
    ],
  },
  "le-petit-chevalier-et-le-pont-de-brume": {
    body: [
      "Aliénor was eleven years old and wore armour several sizes too big. She was a squire, which means a knight who is not finished yet. To become a real knight, she had to bring back the seal of the monastery, on the far side of the valley.",
      "The only way across was the stone bridge. And the stone bridge, as everyone knew, was always drowned in mist.",
      "When Aliénor reached the edge, she could see nothing at all. Not the river below. Not the far bank. Not even the start of the bridge. Just white, as thick as milk.",
      "Her weapons master had given her one single piece of advice the evening before, while cleaning her sword: “On that bridge, your eyes will lie to you. Don't listen to them too much.” Aliénor had found this very mysterious and not very useful.",
      "She reached out with one foot. There was stone. She took one step, then two. By the third step she could no longer see the bank she had just left.",
      "That was when the fear arrived. Not all at once: very slowly, climbing up from her knees. Aliénor stopped dead in the middle of the white, with no idea whether ten steps remained or a hundred.",
      "She thought about turning back. But turning back, in the mist, means choosing a direction at random. So she sat down on the bridge, closed her eyes, and listened.",
      "Then she remembered something old soldiers say: when you cannot see, you are not blind, you are simply busy looking. She decided to stop looking, which is far harder than it sounds.",
      "At first she heard only her own heart. Then, underneath it, far below, the river. A steady sound of water, coming from the left and running away to the right.",
      "She opened her eyes and understood something important: she could not see the bridge, but she could hear the river. And as long as the river passed beneath her from left to right, she was crossing straight, which meant she was going the right way.",
      "So Aliénor stood up and set off again. One step, listen. One step, listen. Whenever the sound of the water slid too far to one side, she corrected herself and carried on.",
      "She dropped to one knee to be sure of not drifting, laid her palm flat on the cold stone and felt, under her hand, the very faint trembling a bridge makes when water runs beneath it.",
      "It took a very long time. Far longer than running across. But after a while her foot found no more stone: it found wet grass.",
      "At the monastery, the old monk who handed her the seal asked whether she had been afraid. “The whole way,” answered Aliénor. The monk nodded, looking pleased. “Good. The others always tell me they were not.”",
      "She had mist in her hair, mist on her oversized armour, and legs that shook a little. The monk looked at her for a long moment before saying anything at all.",
      "On the way home she crossed the bridge again without stopping once. Courage is not about seeing clearly: it is about finding what you can still listen to when you cannot see at all.",
    ],
    quiz: [
      {
        question: "What must Aliénor bring back to become a knight?",
        choices: ["The seal of the monastery", "The king's sword", "A stone from the river"],
        answer: 0,
        explanation: "She must bring back the seal of the monastery, on the far side of the valley.",
      },
      {
        question: "Why does she stop in the middle of the bridge?",
        choices: ["Fear rises and she can no longer see either bank", "The bridge is broken", "She has lost her armour"],
        answer: 0,
        explanation: "She can no longer see the bank she left and does not know if ten steps remain or a hundred.",
      },
      {
        question: "What tells her she is going the right way?",
        choices: ["The sound of the river, running left to right", "The sun behind the mist", "Marks on the stone"],
        answer: 0,
        explanation: "As long as the water passes beneath her from left to right, she is crossing straight.",
      },
      {
        question: "What does Aliénor answer when the monk asks if she was afraid?",
        choices: ["“The whole way”", "“Never”", "“Just a little”"],
        answer: 0,
        explanation: "She answers “The whole way”, and the monk is pleased: the others always say they were not.",
      },
    ],
    glossary: [
      { word: "squire", definition: "A young person learning to become a knight by helping an older one." },
      { word: "mist", definition: "A light white fog that floats close to the ground and hides everything." },
      { word: "seal", definition: "A small engraved stamp pressed into wax to sign an important document." },
    ],
  },
  "qui-a-mange-les-fraises-du-jardin": {
    body: [
      "Pistache was a green dinosaur, not very tall, with a notebook and a pencil always hanging round his neck. That morning he arrived at his strawberry patch and stood there open-mouthed.",
      "Last night he had counted twenty fine red strawberries. This morning there were none left. Not one. Only leaves and little holes in the soil.",
      "“Investigation,” wrote Pistache at the very top of the page. Then he underlined it twice, because an investigation underlined twice is always more serious.",
      "First he went all the way round the patch on all fours, very slowly, holding his pencil like a magnifying glass, which is no help at all but lends an investigation a great deal of seriousness.",
      "First clue: footprints in the soft earth. Very small ones, with four toes. Pistache measured them with his pencil. “Far too small for me,” he noted.",
      "He went to see Croquette the hedgehog, who has exactly four toes. “It wasn't me,” she said. “I don't like strawberries, they stick to my spines.” And that was true, everybody knew it.",
      "Second clue: something was shining between two leaves. A feather. Grey, with a white tip. Pistache tucked it into his notebook and went to see the magpies.",
      "He also noted that the leaves were flattened towards the west, and that three stems had been broken at the same height, as though the thief were not very tall but had come in numbers.",
      "The magpies protested very loudly, all at once, which is their way of saying hello. “We were at the bell tower all night!” Pistache believed them, because they had indeed been heard from the bell tower all night.",
      "He sat down in the grass and read his notes again. Footprints too small. A grey feather. And, he only noticed it now, a smell of pond mud.",
      "So Pistache went to the pond. And there, on the bank, he found the twentieth strawberry, half eaten, beside a family of ducks who were very busy pretending to swim.",
      "So he went back to the patch, sat down exactly where the stems were broken, and looked in the direction the leaves were flattened. Westwards. Which is to say, precisely, towards the pond.",
      "“Hello,” said Pistache. The ducklings looked the other way. The mother duck sighed. “They were hungry. The farm ran out of corn three days ago.”",
      "Pistache looked at the five ducklings, then at his notebook, then at the five ducklings again. He closed the notebook. “I have a better idea than a punishment,” he said.",
      "The youngest duckling, the one still with fluff on his head, waddled up to Pistache, looked at his notebook for a while, and then said very quietly: “They were really good. Especially the big one at the end of the row.” Which, in an investigation, counts as a full confession.",
      "The following spring there were two patches in Pistache's garden: a big one for him, and a small one right at the edge, on purpose, facing the pond. Finding the culprit was half the job. The good half was understanding why.",
    ],
    quiz: [
      {
        question: "How many strawberries had Pistache counted the night before?",
        choices: ["Twenty", "Ten", "Fifty"],
        answer: 0,
        explanation: "He had counted twenty fine red strawberries, and none are left in the morning.",
      },
      {
        question: "Why is Croquette the hedgehog not guilty?",
        choices: ["She dislikes strawberries, they stick to her spines", "She was sleeping at the magpies' nest", "She is far too big"],
        answer: 0,
        explanation: "She does have four toes, but she hates strawberries, and everyone knows it.",
      },
      {
        question: "Which clue leads Pistache to the pond?",
        choices: ["A smell of pond mud", "A magpie feather", "The sound of the bell tower"],
        answer: 0,
        explanation: "Reading his notes again, he notices a smell of pond mud.",
      },
      {
        question: "What does Pistache do once he finds the culprits?",
        choices: ["He plants a second strawberry patch for them", "He tells them off loudly", "He builds a fence"],
        answer: 0,
        explanation: "He understands they were hungry, and plants a small patch on purpose facing the pond.",
      },
    ],
    glossary: [
      { word: "investigation", definition: "A search to find out the truth, by gathering clues one at a time." },
      { word: "footprints", definition: "The marks left by paws or feet in soft ground." },
      { word: "mud", definition: "The soft grey sludge that settles at the bottom of ponds and rivers." },
    ],
  },
  "le-robot-qui-apprenait-a-dire-bonjour": {
    body: [
      "On the first Monday of term there was a new pupil in Mrs Ferrand's class. He was one metre twenty tall, he was grey, and he had two wheels instead of feet. His name was BIP-7.",
      "“BIP-7 is coming to learn with us for a month,” explained the teacher. “He already knows a great many things. He is here to learn the ones you cannot find in books.”",
      "BIP-7 raised one arm and said, very loudly: “HELLO. I AM DELIGHTED TO MAKE YOUR ACQUAINTANCE.” The whole class jumped. One boy dropped his pencil case.",
      "BIP-7 put his bag in locker number twelve, which he measured first to check that the bag would fit, then settled at the back of the class, in the spot where he was in the fewest people's way.",
      "“That's too loud,” said Lina, from the second row. BIP-7 noted something in his program. The next day he said exactly the same sentence, but so quietly that nobody heard it.",
      "“That's too quiet,” said Lina. BIP-7 noted again. On the third day he found the right volume, but he said his sentence to the window, because the window was the first object in the room in his scanning order.",
      "It carried on like that all week. BIP-7 always said the same sentence, complete, perfectly pronounced: “HELLO. I AM DELIGHTED TO MAKE YOUR ACQUAINTANCE.” And every time, something was wrong.",
      "On Thursday he tried saying hello while moving, which produced a sentence cut in half by the noise of his wheels. On Friday morning he said it backwards, starting from the end, which did not help in the slightest.",
      "On Friday he rolled up to the teacher's desk. “I do not understand. My sentence is correct. My volume is correct. Why does it not work?”",
      "Mrs Ferrand thought about it. Then she called Lina over. “Lina, how do you say hello?” Lina shrugged. “Well... it depends.”",
      "“It depends on what?” asked BIP-7, and for the first time all his lights began flashing at once. “On who it is,” said Lina. “On whether you saw them yesterday. On whether they look happy or not.”",
      "“So there is no rule at all?” asked BIP-7, and his voice rose a little, which had never happened before. “There is one,” said Mrs Ferrand. “Look at the person before you speak. The rest comes on its own.”",
      "BIP-7 stayed completely still for eleven seconds, which is a very long time for a robot. Then he deleted his sentence. The whole sentence. Four hundred languages and one single formula, wiped in an instant.",
      "The following Monday he came in, stopped beside the second row and said simply: “Hi Lina.” Then he rolled over to the boy with the pencil case and said: “Is your pencil case all right now?”",
      "He started with the easy ones: the people he had seen the day before, the ones already smiling. He kept for last the ones looking at the floor, because he had calculated that with them you have to try harder.",
      "The class burst out laughing, and BIP-7 recorded the sound of the laughter in a file he named “successful”. It had taken him a week to understand that saying hello is not pronouncing a word: it is showing that you have noticed someone.",
    ],
    quiz: [
      {
        question: "Why has BIP-7 come to the class?",
        choices: ["To learn what is not in books", "To help the teacher with marking", "To repair the computers"],
        answer: 0,
        explanation: "He already knows a great deal: he comes to learn what cannot be found in books.",
      },
      {
        question: "What goes wrong on the third day?",
        choices: ["He says hello to the window", "He speaks too loudly", "He forgets his sentence"],
        answer: 0,
        explanation: "The volume is right, but he addresses the window, first in his scanning order.",
      },
      {
        question: "What does Lina answer when asked how she says hello?",
        choices: ["“It depends”", "“Very loudly”", "“Always the same”"],
        answer: 0,
        explanation: "It depends who it is, whether you saw them yesterday, whether they look happy.",
      },
      {
        question: "What does BIP-7 do once he understands?",
        choices: ["He deletes his ready-made sentence", "He learns a new language", "He turns his volume down"],
        answer: 0,
        explanation: "He wipes his formula completely and starts speaking to each person differently.",
      },
    ],
    glossary: [
      { word: "program", definition: "The list of instructions a robot or computer follows to know what to do." },
      { word: "volume", definition: "How strong a sound is: the greater the volume, the louder you hear it." },
      { word: "file", definition: "A box in a machine's memory, where information is stored so it can be found again." },
    ],
  },
  "une-journee-avec-la-boulangere": {
    body: [
      "Zoé had asked for the same birthday present two years running: to spend a whole day at Aunt Marion's bakery. Not a visit. A real day, from beginning to end.",
      "This year Aunt Marion had said yes. She had only added one sentence: “You do know my day starts at four in the morning?”",
      "Zoé knew. Well, she thought she knew. At ten to four, when the alarm rang in complete darkness, she understood that knowing and living are not the same thing.",
      "Her father dropped her off in front of the lowered shutter, in a completely empty street. There was no light anywhere at all, except one, right at the back of the shop, and that was the bakehouse.",
      "In the bakehouse it was already warm and it smelled wonderful. Aunt Marion gave her a white apron far too big for her and showed her a large bowl filled with a soft grey dough.",
      "“This is Gaspard,” said Aunt Marion seriously. “He is my sourdough starter. He is twenty-six years old. I feed him every day, like an animal. If Gaspard dies, my bread has no taste.”",
      "Zoé looked at the bowl with a great deal more respect. Then she learned to knead. It looks easy from a distance. Close up it is hard work: you push, fold, turn, and start again a hundred times.",
      "Aunt Marion took out a big notebook covered in stains and showed her the timings: loaves at four, pastries at five, shop at seven. “If we slip by a quarter of an hour, everything after it collapses,” she said.",
      "By five o'clock her arms were burning. By six she had flour in her hair, in her ears and a streak across her nose. By seven the first loaves came out of the oven.",
      "And at five past seven the shop door opened on the first customer of the day: a man in work clothes, not properly awake, who said almost nothing.",
      "He bought a baguette, broke off the end outside on the pavement, and ate it right there with his eyes closed. Zoé watched him through the window the whole time.",
      "The bread came out of the oven almost golden, with cracks across the top, and it made a very faint noise as it cooled, a sort of tiny crackling. “That,” said Aunt Marion, “is the bread singing. It is the only moment it does.”",
      "“He does that every morning,” said Aunt Marion. “That is why we get up at four. Not for the bread. For that bit of pavement.”",
      "By midday Zoé was asleep on her feet, with flour up to her elbows. She had kneaded twelve loaves, burnt one croissant and broken a brioche tin.",
      "In the afternoon everything had to be cleaned, the trays scraped, the floor washed and Gaspard fed for the next day. Zoé had assumed the day ended when the shop closed. She was a good two hours out.",
      "On the way home her father asked whether she wanted to be a baker one day. Zoé thought about it for a long time. “I don't know yet,” she said. “But now I know why people do it.”",
    ],
    quiz: [
      {
        question: "What time does Aunt Marion's day begin?",
        choices: ["Four in the morning", "Six in the morning", "Midday"],
        answer: 0,
        explanation: "The alarm rings at ten to four, in complete darkness.",
      },
      {
        question: "Who is Gaspard?",
        choices: ["The bakery's sourdough starter, twenty-six years old", "Aunt Marion's dog", "The first customer of the morning"],
        answer: 0,
        explanation: "He is the sourdough starter, fed every day like an animal for twenty-six years.",
      },
      {
        question: "What does the first customer do with his baguette?",
        choices: ["He breaks off the end and eats it on the pavement", "He cuts it in half to share", "He puts it away in his bag"],
        answer: 0,
        explanation: "He breaks off the end outside and eats it right there, eyes closed.",
      },
      {
        question: "Why does Aunt Marion get up at four?",
        choices: ["For that moment on the pavement", "Because the oven is slow", "To finish earlier in the evening"],
        answer: 0,
        explanation: "She says so herself: not for the bread, for that bit of pavement.",
      },
    ],
    glossary: [
      { word: "bakehouse", definition: "The room in a bakery where the dough is made and where the oven stands." },
      { word: "sourdough", definition: "A living dough that is kept and fed, and that makes bread rise." },
      { word: "knead", definition: "To work dough with your hands, pushing and folding it over and over." },
    ],
  },
  "le-dragon-pompier": {
    body: [
      "Braise had everything a normal dragon needs. Red scales, a thick tail, and breath so hot he could melt a saucepan in twelve seconds.",
      "The trouble was that Braise did not like fire. Not one bit. He found it noisy, dirty, and above all very worrying for the people who lived nearby.",
      "What he wanted to do, he had decided at the age of six while watching the village's red engine drive past: Braise wanted to be a firefighter.",
      "At home nobody understood. His grandmother, who had burned three villages in her youth and still spoke of it with pride, found the whole thing very worrying for the family. “A dragon who puts fires out,” she would say. “Now I have seen everything.”",
      "At the fire station, Captain Roussel had been very polite. “It is a fine idea. But you understand, a dragon in a fire station is rather like a fox in a henhouse.”",
      "Braise had understood. He had gone home. Then he had come back the next day, and the day after that, and for two months, every single morning, to sit in front of the station without asking for anything.",
      "One evening in August the siren went off. A fire in the hills, over by the vineyards, with wind behind it. The bad kind of fire: the kind that runs faster than the engines.",
      "He learned things sitting there. The names of the knots. The sound a beam makes just before it gives way. Why you never open a hot door all at once. He asked no questions: he listened, and he filed it all away in his head.",
      "The firefighters worked all night and could not get around it. In the morning Captain Roussel, black with soot, turned round and saw Braise, sitting in his usual place.",
      "“Can you make wind with those wings?” he asked. “Plenty,” said Braise. “And can you breathe in?” Braise thought about it. “I have never tried it in that direction.”",
      "He tried. He went down to the lake, plunged his head in, and sucked so hard that the ducks shot three metres backwards. Then he rose up, throat full, and blew out over the flames.",
      "Captain Roussel stayed quiet for a moment. Around them the firefighters had stopped moving, hoses in hand, staring at the dragon sitting on the pavement as though seeing him for the first time.",
      "The rain that fell that morning did not come from the sky. It came from a dragon. It took eleven trips to the lake, and by the end Braise could barely stand, but the fire stopped dead in front of the first vineyard.",
      "Today there is a red helmet the size of a bathtub hanging in the Fontclaire fire station. Nobody else can wear it, and nobody has ever suggested taking it down.",
      "Then came three days of smoke, black branches and people coming to say thank you without quite knowing to whom. Braise slept for forty hours straight in the station yard, and nobody woke him.",
      "Braise still breathes fire, of course: he is a dragon. But he has understood something the captain has often repeated since: it is not what you can do that decides your trade, it is what you choose to do with it.",
    ],
    quiz: [
      {
        question: "What job does Braise want?",
        choices: ["Firefighter", "Cook", "Castle guard"],
        answer: 0,
        explanation: "He decided at the age of six, watching the village's red engine drive past.",
      },
      {
        question: "What does Braise do after the captain says no?",
        choices: ["He comes back to sit outside the station every morning", "He goes to live in the hills", "He learns a different trade"],
        answer: 0,
        explanation: "For two months he returns every morning to sit outside the station, asking for nothing.",
      },
      {
        question: "How does Braise put the fire out?",
        choices: ["He sucks up lake water and blows it over the flames", "He breathes fire harder than the blaze", "He digs a ditch with his tail"],
        answer: 0,
        explanation: "He plunges his head in the lake, breathes in, rises and blows the water over the flames.",
      },
      {
        question: "How many trips to the lake does it take?",
        choices: ["Eleven", "Three", "Twenty"],
        answer: 0,
        explanation: "It takes eleven trips, and by the end Braise can barely stand.",
      },
    ],
    glossary: [
      { word: "fire station", definition: "The building where firefighters live and work, along with their engines." },
      { word: "soot", definition: "The black dust that smoke leaves behind on everything it touches." },
      { word: "siren", definition: "The device that wails very loudly to tell the firefighters they must set off." },
    ],
  },
};
